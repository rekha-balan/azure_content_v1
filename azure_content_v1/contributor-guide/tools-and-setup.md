...
## Contents
* [Create a GitHub account and set up your profile](#create-a-github-account-and-set-up-your-profile.md)
* [Sign up for Disqus](#sign-up-for-disqus.md)
* [Determine whether you really need to follow the rest of these steps](#determine-whether-you-really-need-to-follow-the-rest-of-these-steps.md)
* [Permissions in GitHub](#permissions-in-github.md)
* [Install Git for Windows](#install-git-for-windows.md)
* [Enable two-factor authentication](#enable-two-factor-authentication.md)
* [Install a markdown editor](#install-a-markdown-editor.md)
* [Configure Atom](#configure-atom.md)
* [Fork the repository and copy it to your computer](#fork-the-repository-and-copy-it-to-your-computer.md)
* [Configure your user name and email locally](#configure-your-user-name-and-email-locally.md)
...
2. Fill out your profile as follows:
   ...
   * **Full Name**: your full name as displayed in your Microsoft address book listing, plus the bracketed info, which is your alias plus @MSFT. Format: *First Last [alias@MSFT]alias@MSFT]*
