...
* `feed/entry/content/properties/Status` – Model status. One of the following:  * Created - Model is created and does not contain Catalog and Usage.
...
|:--- |:--- |:--- |:--- |
| Item Id |Yes |[A-z]A-z], [a-z]a-z], [0-9]0-9], [_]_] &#40;Underscore&#41;, [-]-] &#40;Dash&#41;<br> Max length: 50 |Unique identifier of an item. |
...
| Features list |No |Any alphanumeric characters <br> Max length: 4000; Max number of features:20 |Comma-separated list of feature name=feature value that can be used to enhance model recommendation; see [Advanced topics](#2-advanced-topics.md) section. |
...
* Retrieve the rank of your features by calling the [Get Features Info](#101-get-features-info-for-last-rank-build.md) API.
* Configure a recommendation build with the following parameters:  * `useFeatureInModel` - Set to True.
