...
Interaction between the models is key if we are to deliver a holistic approach to customer retention. Each model necessarily degrades over time; therefore, the architecture is an implicit loop (similar to the archetype set by the CRISP-DM data mining standard, [***3***]***3***]).  
...
* Derive metrics for four fundamental categories:  * **Entity (for example, a subscription)**. Provision basic information about the subscription and/or customer that is the subject of churn.
...
[2] [Accuracy and precision]2] [Accuracy and precision](http://en.wikipedia.org/wiki/Accuracy_and_precision) on Wikipedia

[3] [CRISP-DM 1.0: Step-by-Step Data Mining Guide]3] [CRISP-DM 1.0: Step-by-Step Data Mining Guide](http://www.the-modeling-agency.com/crisp-dm.pdf)   

[4](./media/machine-learning-azure-ml-customer-churn-scenario/churn-4.png) Big Data Marketing  

[5] [Big Data Marketing: Engage Your Customers More Effectively and Drive Value]5] [Big Data Marketing: Engage Your Customers More Effectively and Drive Value](http://www.amazon.com/Big-Data-Marketing-Customers-Effectively/dp/1118733894/ref=sr_1_12?ie=UTF8qid=1387541531sr=8-12keywords=customer+churn)
 
