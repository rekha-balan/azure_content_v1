...
The list of installed packages can change. To get the complete list, include the following lines in the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module to send the list to the output dataset:

    out <- data.frame(installed.packages())
    maml.mapOutputPort("out")

To view the package list, connect a conversion module such as [Convert to CSV](https://msdn.microsoft.com/library/azure/faa6ba63-383c-4086-ba58-7abf26b85814/) to the output of the [Execute R Script](https://msdn.microsoft.com/library/azure/30806023-392b-42e0-94d6-6b775a6e0fd5/) module, run the experiment, then click the output of the conversion module and select **Download**.
...
* [R modules beginning with A through E](#r-modules-beginning-with-a-through-e.md)
* [R modules beginning with F through L](#r-modules-beginning-with-f-through-l.md)
* [R modules beginning with M through R](#r-modules-beginning-with-m-through-r.md)
* [R modules beginning with S through Z](#r-modules-beginning-with-s-through-z.md)
