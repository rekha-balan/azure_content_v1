...
2. Created a new experiment and used the [Project Columns](https://msdn.microsoft.com/library/azure/1ec722fa-b623-4e26-a44e-a50c6d726223/) module to select the same data features used in Excel   
3. Used the [Split](https://msdn.microsoft.com/library/azure/70530644-c97a-4ab6-85f7-88bf30a8be5f/) module (with *Relative Expression* mode) to divide the data into exact same train sets as had been done in Excel  
...
* When you use the [Linear Regression](https://msdn.microsoft.com/library/azure/31960a6f-789b-4cf7-88d6-2e1152c0bd1a/) module in Azure ML, two methods are provided:  * Online Gradient Descent: May be more suitable for larger-scale problems
