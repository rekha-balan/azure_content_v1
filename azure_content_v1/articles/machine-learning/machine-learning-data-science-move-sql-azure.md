...
1. [Export to Flat File](#export-flat-file.md) 
2. [SQL Database Migration Wizard](#insert-tables-bcp.md)
3. [Database backup and restore](#db-migration.md)
4. [Azure Data Factory](#adf.md)
