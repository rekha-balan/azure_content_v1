...
> [!NOTE]
> This procedure uses the [Azure Portal](https://ms.portal.azure.com/).
> 
> 
...
1. [Linked service for on-premise SQL Server](#adf-linked-service-onprem-sql.md)
2. [Linked service for Azure Blob Storage](#adf-linked-service-blob-store.md)
3. [Linked service for Azure SQL database](#adf-linked-service-azure-sql.md)
...
1. [SQL on-premise Table](#adf-table-onprem-sql.md)
2. [Blob Table ](#adf-table-blob-store.md)
3. [SQL Azure Table](#adf-table-azure-sql.md)

> [!NOTE]
> The following procedures use Azure PowerShell to define and create the ADF activities. But these tasks can also be accomplished using the Azure Portal. For details, see [Create input and output datasets](data-factory-use-onpremises-datasources.md#step-3-create-input-and-output-datasets).
> 
> 
...
> [!NOTE]
> The following procedures use Azure PowerShell to define and create the ADF pipeline. But this task can also be accomplished using the Azure Portal. For details, see [Create and run a pipeline](data-factory-use-onpremises-datasources.md#step-4-create-and-run-a-pipeline).
> 
> 
