...
> [!TIP]
> As an alternative, you can use [Azure Data Factory](https://azure.microsoft.com/services/data-factory/) to create and schedule a pipeline that will move data to a SQL Server VM on Azure. For more information, see [Copy data with Azure Data Factory (Copy Activity)](../data-factory/data-factory-copy-activity.md).
> 
> 
...
1. [Command line bulk copy utility (BCP)](#insert-tables-bcp.md) 
2. [Bulk Insert SQL Query ](#insert-tables-bulkquery.md)
3. [Graphical Built-in Utilities in SQL Server (Import/Export, SSIS)](#sql-builtin-utilities.md)
...
1. [Deploy a SQL Server Database to a Microsoft Azure VM wizard](#deploy-a-sql-server-database-to-a-microsoft-azure-vm-wizard.md)
2. [Export to Flat File](#export-flat-file.md) 
3. [SQL Database Migration Wizard](#sql-migration.md)
4. [Database backup and restore](#sql-backup.md)
...
1. Use any of the methods described in section [Moving Data from File Source](#filesource_to_sqlonazurevm.md) to move the data in flat files to a SQL Server.
