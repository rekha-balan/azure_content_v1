...
1. [Submit Hive queries through Hadoop Command Line in headnode of Hadoop cluster](#headnode.md)
2. [Submit Hive queries with the Hive Editor](#hive-editor.md)
3. [Submit Hive queries with Azure PowerShell Commands](#ps.md)
...
1. [Data Exploration](#hive-dataexploration.md)
2. [Feature Generation](#hive-featureengineering.md)
