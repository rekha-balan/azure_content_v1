...
deployment. You will find the instructions to download and install this application in the properties bar when you select the first node called Predictive Maintenance Data Simulator on the solution template diagram. This application feeds the [Azure Event Hub](#azure-event-hub.md) service
...
from the [Azure Event Hub](#azure-event-hub.md) service and publish results
...
Similar to the [Azure Stream Analytics](#azure-stream-analytics-1.md)
queries, the
[Hive](http://blogs.msdn.com/b/bigdatasupport/archive/2013/11/11/get-started-with-hive-on-hdinsight.aspx)
...
Learning](#azure-machine-learning.md) experiment from the
