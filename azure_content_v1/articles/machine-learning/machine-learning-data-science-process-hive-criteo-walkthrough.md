...
1. [Get the data from Hive tables into Azure Machine Learning](#step1.md)
2. [Create the experiment: clean the data, choose a learner, and featurize with count tables](#step2.md)
3. [Train the model](#step3.md)
4. [Score the model on test data](#step4.md)
5. [Evaluate the model](#step5.md)
6. [Publish the model as a web-service to be consumed](#step6.md)
