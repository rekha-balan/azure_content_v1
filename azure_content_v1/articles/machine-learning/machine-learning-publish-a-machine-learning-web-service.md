...
* **[Create a training experiment](#create-a-training-experiment.md)** - Azure Machine Learning Studio is a collaborative visual development environment that you use to train and test a predictive analytics model using training data that you supply.
* **[Convert it to a predictive experiment](#convert-the-training-experiment-to-a-predictive-experiment.md)** - Once your model has been trained with existing data and you're ready to use it to score new data, you prepare and streamline your experiment for scoring.
* **[Deploy it as a web service](#deploy-the-predictive-experiment-as-a-web-service.md)** - With just a click, you can deploy your scoring experiment as an Azure web service. Users can send data to your model and receive your model's predictions.
...
* **[Access](#access-the-web-service.md)** it through the web service API
* **[Manage](#manage-the-web-service-in-the-azure-management-portal.md)** it through the Azure Classic Portal, and
* **[Update](#update-the-web-service.md)** it if your model changes
