...
1. Finally, in your App.xaml.cs file, make sure to update your `InitNotificationsAsync` method to retrieve the locale and use it when subscribing:
...
<!-- Anchors. -->
[Template concepts]Template concepts]: #concepts
[The app user interface]The app user interface]: #ui
[Building the Windows Store client app]Building the Windows Store client app]: #building-client
