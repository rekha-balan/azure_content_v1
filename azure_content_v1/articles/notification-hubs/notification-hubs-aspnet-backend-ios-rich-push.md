...
1. The app backend:   * Stores the rich payload (in this case, image) in the backend database/local storage
* Sends ID of this rich notification to the device


2. App on the device:   * Contacts the backend requesting the rich payload with the ID it receives
