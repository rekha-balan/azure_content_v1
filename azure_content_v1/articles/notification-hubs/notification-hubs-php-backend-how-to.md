...
Also, if you want you can use the code from the [PHP REST wrapper sample](https://github.com/Azure/azure-notificationhubs-samples/tree/master/notificationhubs-rest-php) and go directly to the [Complete the tutorial](#complete-tutorial.md) section.
...
* Continue learning about Notification Hubs tagging feature in the [Breaking News tutorial]Breaking News tutorial]
* Learn about pushing notifications to individual users in [Notify Users tutorial]Notify Users tutorial]
