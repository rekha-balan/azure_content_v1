...
To learn more, see [table design][]table design][]].

## Next steps
For more tips on managing your SQL Data Warehouse, see [manage overview][]manage overview][]].

<!--Image references-->

<!--Article references-->
[manage overview]manage overview]: sql-data-warehouse-overview-manage.md
