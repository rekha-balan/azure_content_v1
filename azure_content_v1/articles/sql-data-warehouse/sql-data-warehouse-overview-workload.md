...
> [!NOTE]
> With SQL Server CTP2, you can now perform analytics in real-time on an OLTP table. This does not replace the need for a data warehouse to store and analyze data, but it does provide a way to perform analysis in real-time.
> 
> 
...
## Next steps
To start developing your data warehouse, see [development overview][]development overview][]].
