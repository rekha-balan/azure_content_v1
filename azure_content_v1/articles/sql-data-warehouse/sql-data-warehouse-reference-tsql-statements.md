...
## Next steps
For more TSQL examples, see [SQL Data Warehouse development overview][]SQL Data Warehouse development overview][]].

<!--Image references-->

<!--Article references-->
[SQL Data Warehouse development overview]SQL Data Warehouse development overview]: sql-data-warehouse-overview-reference.md
