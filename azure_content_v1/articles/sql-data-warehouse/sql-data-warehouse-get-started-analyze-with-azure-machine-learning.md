...
> [AZURE.VIDEO integrating-azure-machine-learning-with-azure-sql-data-warehouse]AZURE.VIDEO integrating-azure-machine-learning-with-azure-sql-data-warehouse]
> 
> 
## Prerequisites
...
[Create a SQL Data Warehouse](sql-data-warehouse-get-started-provision.md) shows you how to provision a database with sample data. If you already have a SQL Data Warehouse database but do not have sample data, you can [load sample data manually](sql-data-warehouse-get-started-manually-load-samples.md)
...
4. Drag the **Train Model** module into the canvas and specify the inputs. Then, click **Launch column selector** in the Properties pane.   * First input: ML algorithm.
