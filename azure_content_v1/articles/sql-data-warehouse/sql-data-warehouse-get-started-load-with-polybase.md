...
> [AZURE.VIDEO loading-data-with-polybase-in-azure-sql-data-warehouse]AZURE.VIDEO loading-data-with-polybase-in-azure-sql-data-warehouse]
> 
> 
## Prerequisites
...
To learn more, see [Statistics](sql-data-warehouse-develop-statistics.md).  
