...
[ADF Copy][]ADF Copy][]] is part of [Azure Data Factory](http://azure.microsoft.com/services/data-factory/). You can use ADF Copy to export your data to flat files residing on local storage, to remote flat files held in Azure blob storage or directly into SQL Data Warehouse.
...
> 
> 
Head over to the following article for some great [ADF Copy examples]ADF Copy examples].
...
Please refer back to the [migrate your schema]migrate your schema] article for detail on supported data types.
...
3. Copy the data to 3.5 inch SATA II/III hard disk drives using the [Azure Import/Export Tool]Azure Import/Export Tool]
4. Create an Import Job using the Azure Import and Export Service providing the journal files produced by the [Azure Import/Export Tool]Azure Import/Export Tool]
...
<!--Article references-->
[AZCopy]AZCopy]: ../storage/storage-use-azcopy.md
[ADF Copy]ADF Copy]: ../data-factory/data-factory-copy-activity.md
[ADF Copy examples]ADF Copy examples]: ../data-factory/data-factory-copy-activity-examples.md
[development overview]development overview]: sql-data-warehouse-develop-overview.md
[Migrate your solution to SQL Data Warehouse]Migrate your solution to SQL Data Warehouse]: sql-data-warehouse-overview-migrate.md
[SQL Data Warehouse development overview]SQL Data Warehouse development overview]: sql-data-warehouse-overview-develop.md
[Use bcp to load data into SQL Data Warehouse]Use bcp to load data into SQL Data Warehouse]: sql-data-warehouse-load-with-bcp.md
[Use PolyBase to load data into SQL Data Warehouse]Use PolyBase to load data into SQL Data Warehouse]: sql-data-warehouse-get-started-load-with-polybase.md
