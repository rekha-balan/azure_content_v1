...
Pause and resume of your compute power can be done through the [Azure Classic Portal](http://portal.azure.com/), via REST APIs or through Powershell.  Pausing cancels all running or queued activities and when you return you can resume your compute resources in seconds. 
...
For more details on how to use PowerShell please refer to the [Introduction to PowerShell cmdlets][]Introduction to PowerShell cmdlets][]] article.

> [!Note]
> Since storage is separate from compute, your storage is unaffected by pause.
> 
> 
## Next steps
For the performance overview, see [performance overview][]performance overview][]].

<!--Image references-->

<!--Article references-->
[performance overview]performance overview]: sql-data-warehouse-overview-performance.md
[Introduction to PowerShell cmdlets]Introduction to PowerShell cmdlets]: sql-data-warehouse-get-started-powershell-cmdlets.md
