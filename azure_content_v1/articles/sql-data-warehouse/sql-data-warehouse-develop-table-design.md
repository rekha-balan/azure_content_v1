...
> [!NOTE]
> Notice that the second example above makes no mention of the distribution key. Round Robin is the default and so it is not absolutely required. Being explicit however, is considered to be a good practice as ensures that your peers are aware of your intentions when reviewing the table design.
> 
> 
...
> [!NOTE]
> When data is round robin distributed the data is allocated to the distribution at the *buffer* level.
> 
> 
### Recommendations
...
> [!NOTE]
> Remember! The hash is not based on the value of the data but rather on the type of the data being hashed.
> 
> 
...
> [!NOTE]
> When data is hash distributed the data is allocated to the distribution at the row level.
> 
> 
## Table partitions
