...
<!--Image references-->
[1]1]: media/sql-data-warehouse-develop-group-by-options/sql-data-warehouse-develop-group-by-cube.png

<!--Article references-->
[development overview]development overview]: sql-data-warehouse-overview-develop.md

<!--MSDN references-->
[GROUP BY]GROUP BY]: https://msdn.microsoft.com/library/ms177673.aspx
