...
6. Select whether the schedule will run **One Time**, **Hourly**, or **Daily**.
7. Specify a **Start Time** and other options depending on the type of schedule that you selected.
