...
| Type | Description |
|:--- |:--- |
| [Graphical](#graphical-runbooks.md) |Based on Windows PowerShell Workflow and created and edited completely in graphical editor in Azure portal. |
| [PowerShell Workflow](#powershell-workflow-runbooks.md) |Text runbook based on Windows PowerShell Workflow. |
| [PowerShell](#powershell-runbooks.md) |Text runbook based on Windows PowerShell script. |
