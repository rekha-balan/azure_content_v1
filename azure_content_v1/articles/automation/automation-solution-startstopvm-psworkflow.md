...
The workflow starts by getting the values for the [input parameters](#using-the-solution.md).  If the asset names are not provided then default names are used.
