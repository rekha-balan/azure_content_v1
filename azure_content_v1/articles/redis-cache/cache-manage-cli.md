...
| size |-z, --size |Size of the Redis Cache. Valid values: [C0, C1, C2, C3, C4, C5, C6, P1, P2, P3, P4]C0, C1, C2, C3, C4, C5, C6, P1, P2, P3, P4] |
| sku |-x, --sku |Redis SKU. Should be one of : [Basic, Standard, Premium]Basic, Standard, Premium] |
...
| key type |-t, --key-type |Type of key to renew. Valid values: [Primary, Secondary]Primary, Secondary] |
