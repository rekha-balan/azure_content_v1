...
* Create a Cache
* Configure the Cache Clients  * Remove the Managed Cache Service Configuration
* Configure a cache client using the StackExchange.Redis NuGet Package


* Migrate Managed Cache Service code  * Connect to the cache using the ConnectionMultiplexer class
...
> [!NOTE]
> To use Azure Redis Cache, you need an Azure account. If you don’t have one, you can create a free trial account in just a couple of minutes. For details, see [Azure Free Trial](https://azure.microsoft.com/pricing/free-trial/?WT.mc_id=redis_cache_hero).
> 
> 
