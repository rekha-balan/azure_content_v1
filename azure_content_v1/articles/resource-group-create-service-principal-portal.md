...
6. Select the type of application you would like to create. For this tutorial, we will not use an application from the gallery.

     ![new application][10]

7. Fill in name of the application and select the type of application you want to use. Select the type of application you are creating. For this tutorial, we will elect to create a **WEB APPLICATION AND/OR WEB API** and click the next button.
