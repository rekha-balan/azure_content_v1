...
> [!NOTE]
> This step is required only if you want to perform management operations (create and delete of clusters) in logic app.
> 
> 
...
> [!NOTE]
> If you want to change the certificate, you can upload another certificate, which replaces the existing certificate.
> 
> 
