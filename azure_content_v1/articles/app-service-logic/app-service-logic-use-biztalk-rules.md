...
![Alt text][3]
5. In the new blade that opens, enter the following information:     1. Name – give a name for your Rules API App
...
## Literal Definition
1. After clicking on “Add”, a new “Add Definition” Blade Opens up. Enter the following values   1. Name – only alphanumeric characters are expected without any special characters. This should also be unique to your existing vocabulary definition list.
