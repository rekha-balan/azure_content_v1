...
1. To enable Git publishing, you must provide a user name and password. Make a note of the user name and password you create. (If you have set up a Git repository before, this step will be skipped.)
...
3. Browse to **http://[site name]site name].azurewebsites.net/index.php** to begin using the application (this information will be stored on your account dashboard):
...
3. Browse to **http://[site name]site name].azurewebsites.net/index.php** to see your app and any changes you may have made:
