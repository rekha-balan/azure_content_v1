...
Blob storage is geo-distributed across regions by default, so you don't have to worry about replicating files across all sites. You can be also enable the Azure [Content Distribution Network (CDN)](../cdn-how-to-use.md) for Blob storage, which distributes files to end nodes closer to your visitors.
