...
## Overview
Since an App Service Environment is always created in a subnet of a regional classic "v1" [virtual network](https://azure.microsoft.com/documentation/articles/virtual-networks-faq/), outbound connections from an App Service Environment to other backend resources can flow exclusively over the virtual network.  
