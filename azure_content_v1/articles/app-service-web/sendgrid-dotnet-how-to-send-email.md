...
[Next steps](#next-steps.md) section.
...
For more information, see [https://sendgrid.com](https://sendgrid.com) or our [C# library](https://github.com/sendgrid/sendgrid-csharp)
...
**SendGrid** type, see [sendgrid-csharp](https://github.com/sendgrid/sendgrid-csharp) on GitHub.
...
* SendGrid C\# library repo: [sendgrid-csharp](https://github.com/sendgrid/sendgrid-csharp)
