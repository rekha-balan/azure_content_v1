...
3. Add the domain name inside the [Azure Portal](https://portal.azure.com).
...
> [!NOTE]
> You can use Azure DNS to host the necessary domain records for your web app. To configure your custom domain, and create your records, in Azure DNS, see [Create custom DNS records for a web app](../dns-web-sites-custom-domain.md).
> 
> 
<a name="awverify" />
