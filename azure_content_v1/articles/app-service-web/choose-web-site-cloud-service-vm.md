...
## Overview
Azure offers several ways to host web sites: [Azure App Service](/services/app-service/), [Cloud Services](http://go.microsoft.com/fwlink/?LinkId=306052), and [Virtual Machines](http://go.microsoft.com/fwlink/?LinkID=306053). This article helps you understand the options and make the right choice for your web application.

Azure App Service is the best choice for most web apps. Deployment and management are integrated into the platform, sites can scale quickly to handle high traffic loads, and the built-in load balancing and traffic manager provide high availability. You can move existing sites to Azure App Service easily with an [online migration tool](https://www.migratetoazure.net/), use an open-source app from the Web Application Gallery, or create a new site using the framework and tools of your choice. The [WebJobs](http://go.microsoft.com/fwlink/?linkid=390226clcid=0x409) feature makes it easy to add background job processing to your App Service web app.
...
* [I need a web front end with background processing and database backend to run business applications integrated with on premise assets.](#onprem.md)
* [I need a reliable way to host my corporate website that scales well and offers global reach.](#corp.md)
* [I have an IIS6 application running on Windows Server 2003.](#iis6.md)
* [I'm a small business owner, and I need an inexpensive way to host my site but with future growth in mind.](#smallbusiness.md)
* [I'm a web or graphic designer, and I want to design and build web sites for my customers.](#designer.md)
* [I'm migrating my multi-tier application with a web front-end to the Cloud.](#multitier.md)
* [My application depends on highly customized Windows or Linux environments and I want to move it to the cloud.](#custom.md)
* [My site uses open source software, and I want to host it in Azure.](#oss.md)
* [I have a line-of-business application that needs to connect to the corporate network.](#lob.md)
* [I want to host a REST API or web service for mobile clients.](#mobile.md)
