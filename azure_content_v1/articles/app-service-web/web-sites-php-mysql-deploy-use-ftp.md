...
1. Enter values for your new database, including agreeing to the legal terms.

    ![Create new MySQL database][new-mysql-db]

2. When the web app has been created, you will see the new app service blade.


1. Click on **Settings** > **Deployment credentials**. 

    ![Set deployment credentials][set-deployment-credentials]

2. To enable FTP publishing, you must provide a user name and password. Save the credentials and make a note of the user name and password you create.
