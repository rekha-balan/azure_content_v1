...
* Completion of the tutorial [Create a Xamarin.Forms app](../app-service-mobile-xamarin-forms-get-started.md). This article uses the completed app from that tutorial.
