...
* In Android Studio, [update the Gradle build files](#gradle-build.md), and
* [Enable internet permission](#enable-internet.md)
...
* [Return all Items](#showAll.md)
* [Filter returned data](#filtering.md)
* [Sort returned data](#sorting.md)
* [Return data in pages](#paging.md)
* [Select specific columns](#selecting.md)
* [Concatenate query methods](#chaining.md)
...
You can [read an overview](notification-hubs-overview.md/#integration-with-app-service-mobile-apps.md) that describes how Microsoft Azure Notification Hubs supports a wide variety of push notifications,
