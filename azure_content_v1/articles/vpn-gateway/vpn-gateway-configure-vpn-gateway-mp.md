...
If you already have a VPN gateway and you want to change the routing type, see [How to change your VPN gateway type](#how-to-change-your-vpn-gateway-type.md).

1. [Create a VPN gateway](#create-a-vpn-gateway.md)

2. [Gather information for your VPN device configuration](#gather-information-for-your-vpn-device-configuration.md)

3. [Configure your VPN device](#configure-your-vpn-device.md)

4. [Verify your local network ranges and VPN gateway IP address](#verify-your-local-network-ranges-and-vpn-gateway-ip-address.md)
...
2. **Create a new VPN gateway.**
    ...
    Use the procedure at the top of the page to create a new gateway: [Create a VPN gateway](#create-a-vpn-gateway.md).
