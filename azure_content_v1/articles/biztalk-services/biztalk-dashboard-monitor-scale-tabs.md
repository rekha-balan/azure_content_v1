...
For a description of these performance metrics, go to [Available Metrics](#Metrics.md) in this topic.
...
<br/><br/>
[Destination acknowledgement response sent to the gateway]Destination acknowledgement response sent to the gateway] - [Message enters the gateway]Message enters the gateway]</td>
</tr>
<tr>
...
[Destination acknowledgement response sent to the gateway]Destination acknowledgement response sent to the gateway] - [Message enters the gateway]Message enters the gateway] - [Destination response is received]Destination response is received] + [Message is routed to the destination]Message is routed to the destination]</td>
</tr>
<tr>
