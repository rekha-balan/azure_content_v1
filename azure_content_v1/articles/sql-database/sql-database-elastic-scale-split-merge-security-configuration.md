...
1. [To Configure the SSL Certificate](To#Configure#the#SSL#Certificate.md)
2. [To Configure Client Certificates](To#Configure#Client#Certificates.md) 
...
1. [Create a Self-Signed Certificate](Create#a#Self-Signed#Certificate.md)
2. [Create PFX file for Self-Signed SSL Certificate](Create#PFX#file#for#Self-Signed#SSL#Certificate.md)
3. [Upload SSL Certificate to Cloud Service](Upload#SSL#Certificate#to#Cloud#Service.md)
4. [Update SSL Certificate in Service Configuration File](Update#SSL#Certificate#in#Service#Configuration#File.md)
5. [Import SSL Certification Authority](Import#SSL#Certification#Authority.md)

### To Use an existing certificate from the certificate store
1. [Export SSL Certificate From Certificate Store](Export#SSL#Certificate#From#Certificate#Store.md)
2. [Upload SSL Certificate to Cloud Service](Upload#SSL#Certificate#to#Cloud#Service.md)
3. [Update SSL Certificate in Service Configuration File](Update#SSL#Certificate#in#Service#Configuration#File.md)

### To Use an existing certificate in a PFX file
1. [Upload SSL Certificate to Cloud Service](Upload#SSL#Certificate#to#Cloud#Service.md)
2. [Update SSL Certificate in Service Configuration File](Update#SSL#Certificate#in#Service#Configuration#File.md)
...
1. [Turn Off Client Certificate-Based Authentication](Turn#Off#Client#Certificate-Based#Authentication.md)

### Issue new self-signed client certificates
1. [Create a Self-Signed Certification Authority](Create#a#Self-Signed#Certification#Authority.md)
2. [Upload CA Certificate to Cloud Service](Upload#CA#Certificate#to#Cloud#Service.md)
3. [Update CA Certificate in Service Configuration File](Update#CA#Certificate#in#Service#Configuration#File.md)
4. [Issue Client Certificates](Issue#Client#Certificates.md)
5. [Create PFX files for Client Certificates](Create#PFX#files#for#Client#Certificates.md)
6. [Import Client Certificate](Import#Client#Certificate.md)
7. [Copy Client Certificate Thumbprints](Copy#Client#Certificate#Thumbprints.md)
8. [Configure Allowed Clients in the Service Configuration File](Configure#Allowed#Clients#in#the#Service#Configuration#File.md)

### Use existing client certificates
1. [Find CA Public Key](Find#CA#Public Key.md)
2. [Upload CA Certificate to Cloud Service](Upload#CA#certificate#to#cloud#service.md)
3. [Update CA Certificate in Service Configuration File](Update#CA#Certificate#in#Service#Configuration#File.md)
4. [Copy Client Certificate Thumbprints](Copy#Client#Certificate#Thumbprints.md)
5. [Configure Allowed Clients in the Service Configuration File](Configure#Allowed#Clients#in#the#Service#Configuration File.md)
6. [Configure Client Certificate Revocation Check](Configure#Client#Certificate#Revocation#Check.md)
...
1. [Create a Self-Signed Certificate](Create#a#Self-Signed#Certificate.md)
2. [Create PFX file for Self-Signed Encryption Certificate](Create#PFX#file#for#Self-Signed#Encryption#Certificate.md)
3. [Upload Encryption Certificate to Cloud Service](Upload#Encryption#Certificate#to#Cloud#Service.md)
4. [Update Encryption Certificate in Service Configuration File](Update#Encryption#Certificate#in#Service#Configuration#File.md)

### Use an existing certificate from the certificate store
1. [Export Encryption Certificate From Certificate Store](Export#Encryption#Certificate#From#Certificate#Store.md)
2. [Upload Encryption Certificate to Cloud Service](Upload#Encryption#Certificate#to#Cloud#Service.md)
3. [Update Encryption Certificate in Service Configuration File](Update#Encryption#Certificate#in#Service#Configuration#File.md)

### Use an existing certificate in a PFX file
1. [Upload Encryption Certificate to Cloud Service](Upload#Encryption#Certificate#to#Cloud#Service.md)
2. [Update Encryption Certificate in Service Configuration File](Update#Encryption#Certificate#in#Service#Configuration#File.md)
...
* Export certificate into a .PFX file with these options:  * Yes, export the private key
...
* Find certificate  * Search for a client certificate issued by the same Certification Authority
...
* Find certificate  * Search for the CA noted above.


* Click Actions -> All tasks -> Export…
* Export certificate into a .CER with these options:  * **No, do not export the private key**
* Include all certificates in the certification path if possible.
* Export all extended properties.
...
* Import certificate into the Personal store with at least this option:  * Include all extended properties checked
...
4. If importing a .PFX file:   1. Enter the password protecting the private key
