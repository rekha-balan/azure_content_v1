...
![Elastic database job service][1][Elastic database job service][1]Elastic database job service][1]1]
...
3. Two different roles communicate with the control database:    * Controller: Determines which jobs require tasks to perform the requested job, and retries failed jobs by creating new job tasks.
...
<!--Image references-->
[1]1]: ./media/sql-database-elastic-jobs-overview/elastic-jobs.png
<!--anchors-->
