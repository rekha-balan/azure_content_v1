...
> [!IMPORTANT]
> Upgrading Web or Business databases to a new service tier does not take the database offline. The database will remain online and available throughout the upgrade operation. 
> 
> 
...
> [!NOTE]
> You can now use the [sys.dm_db_resource_stats](https://msdn.microsoft.com/library/dn800981.aspx) view in Web and Business databases for a higher granularity view (every 15 seconds) of resource consumption data. Because sys.dm_db_resource_stats only retains historical data for one hour you can query this DMV every hour and store the data for additional analysis.
> 
> 
