...
> [!NOTE]
> SQL Server Management Studio does not support connections to SQL Database in versions prior to SQL Server 2008 R2.
> 
> 
...
> [!NOTE]
> Microsoft recommends using contained database users to enhance scalability.
> 
> 
