...
![Query across shards][1][Query across shards][1]Query across shards][1]1]
...
<!--Image references-->
[1]1]: ./media/sql-database-elastic-query-horizontal-partitioning/horizontalpartitioning.png
<!--anchors-->
