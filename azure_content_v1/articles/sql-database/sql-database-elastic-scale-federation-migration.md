...
1. [Create a Shard Map Manager from a Federation Root](#create-a-shard-map-manager-from-a-federation-root.md) 
2. [Modify the Existing Application](#modify-the-existing-application.md)
3. [Switch Out Existing Federation Members](#switch-out-existing-federation-members.md)
