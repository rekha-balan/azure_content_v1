...
![Blogging app architecture][1][Blogging app architecture][1]Blogging app architecture][1]1]

## Download the sample project
### Prerequisites
* Use Visual Studio (2012 or higher) 
* Create three Azure SQL Databases 
* Download sample project: [Elastic DB Tools for Azure SQL - Multi-Tenant Shards](http://go.microsoft.com/?linkid=9888163)  * Fill in the information for your databases at the beginning of **Program.cs** 
...
<!--Image references-->
[1]1]: ./media/sql-database-elastic-tools-multi-tenant-row-level-security/blogging-app.png
<!--anchors-->
