...
* Use the *NuGet* package manager feature in Visual Studio:  * In NuGet, search for **enterpriselibrary**.
...
3. Construct a **RetryPolicy** object. Input parameters are:   * **ExponentialBackoff** object.
* **SqlDatabaseTransientErrorDetectionStrategy** object.


4. Construct a **ReliableSqlConnection** object. Input parameters are:   * A **String** object - with server name and the other connection info.
* **RetryPolicy** object.


5. Call to connect, made through the **RetryPolicy .ExecuteAction** method.
6. Call the **ReliableSqlConnection .CreateCommand** method.   * Returns a **System.SqlClient.Data.DbCommand** object, part of ADO.NET.
...
[Enterprise Library 6 – April 2013](http://msdn.microsoft.com/library/dn169621.aspx)  * This topic has a button at its top that offers to [download the EntLib60 source code](http://go.microsoft.com/fwlink/p/?LinkID=290898), if you are curious to see the source code.
