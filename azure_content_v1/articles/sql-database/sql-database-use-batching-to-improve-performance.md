...
> [!NOTE]
> Results are not benchmarks. See the [note about timing results in this topic](#note-about-timing-results-in-this-topic.md).
> 
> 
...
| Batch size [Iterations]Iterations] | Two threads (ms) | Four threads (ms) | Six threads (ms) |
| --- | --- | --- | --- |
| 1000 [1]1] |277 |315 |266 |
| 500 [2]2] |548 |278 |256 |
| 250 [4]4] |405 |329 |265 |
| 100 [10]10] |488 |439 |391 |
...
* For the fastest insert performance, follow these general guidelines but test your scenario:  * For < 100 rows, use a single parameterized INSERT command.
...
* Batch size guidelines:  * Use the largest batch sizes that make sense for your application and business requirements.
