...
![Elastic database query used on scaled-out data tier][1][Elastic database query used on scaled-out data tier][1]Elastic database query used on scaled-out data tier][1]1]
...
![Vertical partitioning - Using elastic query to query reference data][3][Vertical partitioning - Using elastic query to query reference data][3]Vertical partitioning - Using elastic query to query reference data][3]3]
...
![Vertical partitioning - Using elastic query to query across various databases][4][Vertical partitioning - Using elastic query to query across various databases][4]Vertical partitioning - Using elastic query to query across various databases][4]4]
...
![Horizontal partitioning - Using elastic query for reporting over sharded data tiers][5][Horizontal partitioning - Using elastic query for reporting over sharded data tiers][5]Horizontal partitioning - Using elastic query for reporting over sharded data tiers][5]5]
...
<!--Image references-->
[1]1]: ./media/sql-database-elastic-query-overview/overview.png
[2]2]: ./media/sql-database-elastic-query-overview/topology1.png
[3]3]: ./media/sql-database-elastic-query-overview/vertpartrrefdata.png
[4]4]: ./media/sql-database-elastic-query-overview/verticalpartitioning.png
[5]5]: ./media/sql-database-elastic-query-overview/horizontalpartitioning.png
