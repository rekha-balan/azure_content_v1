...
![Query across tables in different databases][1][Query across tables in different databases][1]Query across tables in different databases][1]1]
...
<!--Image references-->
[1]1]: ./media/sql-database-elastic-query-vertical-partitioning/verticalpartitioning.png
