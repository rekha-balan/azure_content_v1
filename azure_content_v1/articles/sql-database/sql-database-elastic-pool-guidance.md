...
1. Calculate the price for the pool as follows:
...
1. Compare the pool price from Step 3 to the price of using the appropriate performance levels for single databases. 
...
> [!IMPORTANT]
> You must keep the PowerShell window open while running the script. Do not close the PowerShell window until you have run the script for a sufficient amount of time and captured enough data to represent your typical workload spanning both normal and peak usage times. 
> 
> 
### Script prerequisites
Install the following prior to running the script.:

* The latest [Powershell command-line tools](http://go.microsoft.com/?linkid=9811175clcid=0x409).
