...
* [Visual Studio Express for Web](#vwd.md)
* [Microsoft ASP.NET and Web Tools for Visual Studio](#wte.md)
* [Microsoft Azure Tools for Microsoft Visual Studio](#tools.md)
* [Microsoft Azure Authoring Tools](#auth.md)
* [Microsoft Azure Emulator](#emulator.md)
* [Microsoft Azure Storage Emulator](#stgemulator.md)
* [Microsoft Azure Storage Tools](#stgtools.md)
* [Microsoft Azure Libraries for .NET](#libraries.md)
* [HDInsight Tools for Visual Studio](#hdinsight.md) and [Microsoft Hive ODBC Driver](#hdinsight.md)
* [Microsoft Azure Mobile App SDK V1.0](#mobile.md)
* [Microsoft Azure PowerShell](#ps.md)
...
* [Many Azure features are already in Visual Studio. Do I need to install the Azure SDK for .NET?](#azinvs.md)
* [I want a client library. Do I have to install the Azure SDK for .NET to get it?](#clientlib.md)
* [Where can I find older versions of the Azure SDK for .NET?](#olderversions.md)
* [What's the lifecycle policy for versions of the Azure SDK for .NET?](#lifecycle.md)
* [Which guest OS versions is the Azure SDK for .NET compatible with?](#guestos.md)
* [How do I uninstall the Azure SDK for .NET?](#uninstall.md)
...
Each item shown in this article under [What's included in the Azure SDK for .NET](#included.md) is a separate program in the list of installed programs in Windows Control Panel **Programs and Features**.  There is no way to uninstall them as a group; you have to uninstall each program individually.
