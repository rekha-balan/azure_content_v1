...
> [!NOTE]
> This topic is about deploying to cloud services, not to web sites. For information about deploying to web sites, see [Deploy a web app in Azure App Service](web-sites-deploy.md).
> 
> 
...
3. To copy the ADO.NET connection string to use for your connection string, perform the following steps in the management portal for Azure.  
...
2. Add the tables and fields that you need for this database from the Azure Management Portal.
