...
The [Application Insights - Start monitoring your app's health and usage](app-insights-start-monitoring-app-health-usage/.md) page on the Microsoft website provides more information.
