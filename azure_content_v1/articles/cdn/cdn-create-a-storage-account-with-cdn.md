...
3. In the **Storage** field, type a subdomain name. This entry can contain 3-24 lowercase letters and numbers.
...
4. Select a **Pricing tier** or use the default.  For more information on pricing tiers, see [Azure Storage Pricing](../../pricing/details/storage.md).

5. Select or create a **Resource Group**.  For more information on Resource Groups, see [Azure Resource Manager overview](resource-group-overview/#resource-groups.md). 

6. Select the **Subscription** that the storage account will be used with.

7. Click **Create**. The process of creating the storage account might take several minutes to complete.
...
> [!TIP]
> If you already have a CDN profile that you want to use for this tutorial, proceed to [Step 3](#step-3-create-a-new-cdn-endpoint.md).
> 
> 
