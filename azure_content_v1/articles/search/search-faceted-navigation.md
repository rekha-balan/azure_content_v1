...
* [How to build it](#howtobuildit.md)
* [Build the presentation layer](#presentationlayer.md)
* [Build the index](#buildindex.md)
* [Check for data quality](#checkdata.md)
* [Build the query](#buildquery.md)
* [Tips on how to control faceted navigation](#tips.md)
* [Faceted navigation based on range values](#rangefacets.md)
* [Faceted navigation based on GeoPoints](#geofacets.md)
