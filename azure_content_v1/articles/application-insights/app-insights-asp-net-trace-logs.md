...
> 
> 
If you haven't yet [set up Application Insights for your project](app-insights-overview.md), do that now. Your project should have the file `ApplicationInsights.config` and the NuGet package `Microsoft.ApplicationInsights.Web`.
...
## Explore your logs
In your app's overview blade in [the Application Insights portal](http://portal.azure.com/), choose [Search](app-insights-diagnostic-search.md).
...
> 
## Next steps
[Diagnose failures and exceptions in ASP.NET](app-insights-web-failures-exceptions.md)
