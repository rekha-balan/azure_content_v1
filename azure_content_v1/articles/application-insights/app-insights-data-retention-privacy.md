...
[More detail](#data-sent-by-application-insights.md).
...
| [Install Status Monitor on IIS](app-insights-monitor-performance-live-website-now.md)<br/>[Add AI Extension to Azure VM or Web App](../insights-perf-analytics.md) |Dependencies<br/>ServerContext<br/>Inferred<br/>Perf counters |
...
| [Add JavaScript SDK to web page](app-insights-javascript.md) |ClientContext <br/>Inferred<br/>Page<br/>ClientPerf |
...
#### Introduction
> [AZURE.VIDEO application-insights-introduction]AZURE.VIDEO application-insights-introduction]
> 
> 
#### Get started
