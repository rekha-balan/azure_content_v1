...
* [URL ping test](#set-up-a-url-ping-test.md): a simple test that you can create in the Azure portal.
* [Multi-step web test](#multi-step-web-tests.md): which you create in Visual Studio Ultimate or Visual Studio Enterprise and upload to the portal.
...
> [AZURE.VIDEO monitoring-availability-with-application-insights]AZURE.VIDEO monitoring-availability-with-application-insights]
> 
> 
