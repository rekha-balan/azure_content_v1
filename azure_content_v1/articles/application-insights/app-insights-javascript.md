...
> [!NOTE]
> Metrics can only be displayed in some combinations. When you select a metric, the incompatible ones are disabled.
> 
> 
## Custom page counts
...
> [AZURE.VIDEO tracking-usage-with-application-insights]AZURE.VIDEO tracking-usage-with-application-insights]
> 
> 
