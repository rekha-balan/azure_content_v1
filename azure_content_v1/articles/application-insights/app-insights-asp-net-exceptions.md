...
To monitor an ASP.NET app, you have to [add Application Insights SDK](app-insights-asp-net.md) to your application, or [install Status Monitor on your IIS server](app-insights-monitor-performance-live-website-now.md), or, if your app is an Azure Web App, add the [Application Insights Extension](../insights-perf-analytics.md).
...
*No exceptions showing? See [Capture exceptions](#exceptions.md).*
...
To get dependency data, you have to [install Status Monitor](app-insights-monitor-performance-live-website-now.md) on your IIS server, or if your app is an Azure Web App, use the [Application Insights Extension](../insights-perf-analytics.md). 
...
* [TrackException()](#exceptions.md) sends stack traces. [More about exceptions](#exceptions.md).
