...
Marcela Markova is a test specialist on the OBS team, and takes the lead on monitoring online performance. She sets up several [web tests](app-insights-monitor-web-app-availability.md):
...
#### Alerts
So she sets two [alerts](app-insights-metrics-explorer.md): one for response times greater than a typical threshold, and another for a rate of failed requests greater than the current background.
