...
1. Add the [Application Insights for Web](http://www.nuget.org/packages/Microsoft.ApplicationInsights.Web) NuGet package. This version of the SDK includes modules that add server context such as role information. For worker roles, use Application Insights for Windows Services.

    ![Search for "Application Insights"](./media/app-insights-cloudservices/04-ai-nuget.png)


1. Configure the SDK to send data to the Application Insights resource.
...
* [Using PowerShell to send Azure diagnostics to Application Insights]Using PowerShell to send Azure diagnostics to Application Insights])(app-insights-powershell-azure-diagnostics.md)
