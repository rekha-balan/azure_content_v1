...
#### Page views
To discover the paths that users follow through your app, insert [page view telemetry](app-insights-api-custom-events-metrics.md) into  your code:
...
See [API reference](app-insights-api-custom-events-metrics.md) for more about custom events.
...
[Know your users](app-insights-overview-usage.md)
