...
Expressions are enclosed with brackets ([ and ] and ]), and are evaluated when the artifact is installed. Expressions can appear anywhere in a JSON string value and always return another JSON value. If you need to use a literal string that starts with a bracket [, you must use two brackets [[.
...
5. Add the artifacts repository to the lab - Refer to the article, [Add a Git artifact repository to your DevTest Lab](devtest-lab-add-artifact-repo.md).
