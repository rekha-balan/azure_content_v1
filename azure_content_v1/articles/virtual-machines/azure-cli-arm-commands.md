...
<BR>
    network lb address-pool delete [options]options] <resource-group> <lb-name> <name>
...
<br>
    network public-ip list [options]options] <resource-group>
...
Parameter options:
    ...
    -s, --subscription <subscription>      the subscription identifier
<BR>
    network public-ip show [options]options] <resource-group> <name>
