...
> [!TIP]
> If you use the [HPC Pack IaaS deployment script](virtual-machines-hpcpack-cluster-powershell-script.md) to create the cluster in Azure,
...
> [!NOTE]
> Don't reuse an existing cloud service in your subscription. Also don't
