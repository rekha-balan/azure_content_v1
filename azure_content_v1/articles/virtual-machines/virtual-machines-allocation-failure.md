...
* Delete all VMs from the cloud service and re-create VMs.<br>
  Click **Browse all** > **Virtual machines (classic)** > your virtual machine > **Delete**. Then, click **New** > **Compute** > [virtual machine image]virtual machine image].
...
> [!NOTE]
> The error listed in each allocation scenario is a short form. Refer to the [Appendix](#appendix.md) for detailed error strings.
> 
> 
