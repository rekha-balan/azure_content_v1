...
6. For **Data**, set the path to **f:\Data**.
7. For **Log**, set the path to **f:\Log**.
8. For **Backup**, set the path to **f:\Backup**.
9. Only new databases use these locations.
10. Click **OK** to close the window.
11. In the left pane, expand the **Security folder**.
12. Right-click **Logins**, and then click **New login**.
13. In **Login name**, type *domain*\sp_farm_db in (in which *domain* is the name of the domain in which the sp_farm_db account was created).
14. Under **Select a page**, click **Server Roles**, click **sysadmin**, and then click **OK**.
15. Close SQL Server 2014 Management Studio.
...
4. In **Enter the object names to select**, type [domain]domain]**\sp_farm_db**, and then click **OK** three times.
...
6. Click the virtual-machines-manage-availability tab, then type [Domain]Domain]**\sqlservice** in **Account Name**. Type the sqlservice account password in **Password** and **Confirm password**, and then click **OK**.
