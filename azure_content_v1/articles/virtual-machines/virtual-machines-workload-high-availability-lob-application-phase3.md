...
11. Run the following commands from a Windows PowerShell prompt:    * md f:\Data
* md f:\Log
* md f:\Backup
...
5. In **Database default locations**, set the following values:    * For **Data**, set the path to **f:\Data**.
...
4. In **Enter the object names to select**, type [domain]domain]**\sqladmin**, and then click **OK** three times.
