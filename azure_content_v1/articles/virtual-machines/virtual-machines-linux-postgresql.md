...
1. Edit the *bash_profile* file by entering the commands below. These lines will be added to the end of the *bash_profile* file:
     ...
     alias ll='ls -lh'
     EOF
2. Execute the *bash_profile* file:

        $ source .bash_profile
3. Validate your installation by using the following command:
    ...
    If your installation is successful, you will see the following response:
        ...
        /opt/pgsql/bin/psql
4. You can also check the PostgreSQL version:
