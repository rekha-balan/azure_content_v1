...
> [AZURE.NOTE] Azure has two different deployment models for creating and working with resources:  [Resource Manager and classic](../resource-manager-deployment-model.md).  This article covers using the Resource Manager deployment model, which Microsoft recommends for most new deployments instead of the classic deployment model. You can't use templates in the classic deployment model.

* [Quick-create a virtual machine in Azure](#quick-create-a-vm-in-azure.md)
* [Deploy a virtual machine in Azure from a template](#deploy-a-vm-in-azure-from-a-template.md)
* [Create a virtual machine from a custom image](#create-a-custom-vm-image.md)
* [Deploy a virtual machine that uses a virtual network and a load balancer](#deploy-a-multi-vm-application-that-uses-a-virtual-network-and-an-external-load-balancer.md)
* [Remove a resource group](#remove-a-resource-group.md)
* [Show the log for a resource group deployment](#show-the-log-for-a-resource-group-deployment.md)
* [Display information about a virtual machine](#display-information-about-a-virtual-machine.md)
* [Connect to a Linux-based virtual machine](#log-on-to-a-linux-based-virtual-machine.md)
* [Stop a virtual machine](#stop-a-virtual-machine.md)
* [Start a virtual machine](#start-a-virtual-machine.md)
* [Attach a data disk](#attach-a-data-disk.md)
