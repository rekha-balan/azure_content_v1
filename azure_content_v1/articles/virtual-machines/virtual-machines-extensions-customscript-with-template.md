...
* [Deploying Templates with Azure CLI](virtual-machines-deploy-rmtemplates-azure-cli.md)
* [Deploying Templates with Azure Powershell](virtual-machines-deploy-rmtemplates-powershell.md)

### Prerequistes
1. Install the latest Azure PowerShell Cmdlets or Azure CLI from [here](https://azure.microsoft.com/downloads/).
2. If the scripts will be run on an existing VM, make sure VM Agent is enabled on the VM, if not follow [this](virtual-machines-extensions-install.md) to install one.
