...
| --- | --- | --- | --- |
| 1. |******__****** (first domain controller, example DC1) |Windows Server 2012 R2 Datacenter |Standard_D2 |
| 2. |******__****** (second domain controller, example DC2) |Windows Server 2012 R2 Datacenter |Standard_D2 |
| 3. |******__****** (primary database server, example SQL1) |Microsoft SQL Server 2014 Enterprise – Windows Server 2012 R2 |Standard_DS4 |
| 4. |******__****** (secondary database server, example SQL2) |Microsoft SQL Server 2014 Enterprise – Windows Server 2012 R2 |Standard_DS4 |
| 5. |******__****** (majority node for the cluster, example MN1) |Windows Server 2012 R2 Datacenter |Standard_D1 |
| 6. |******__****** (first web server, example WEB1) |Windows Server 2012 R2 Datacenter |Standard_D3 |
| 7. |******__****** (second web server, example WEB2) |Windows Server 2012 R2 Datacenter |Standard_D3 |
