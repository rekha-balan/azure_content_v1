...
* [Windows installer](http://go.microsoft.com/?linkid=9828653clcid=0x409)
...
> [!NOTE]
> On Linux distributions, you may need to use `sudo` to successfully run the **npm** command.
> 
> 
...
> [!NOTE]
> For Linux systems, you can also install the Azure CLI by building it from the [source](http://go.microsoft.com/fwlink/?linkid=253472). For more information on building from source, see the INSTALL file included in the archive.
> 
> 
...
* [Use the Azure CLI with Azure Resource Manager](virtual-machines/xplat-cli-azure-resource-manager.md)

* [Use the Azure CLI with Azure Service Management](virtual-machines/virtual-machines-command-line-tools.md)
