...
## Upload content
1. In the [Azure Classic Portal](http://go.microsoft.com/fwlink/?LinkID=256666clcid=0x409), click **Media Services** and then click the Media Services account name.
