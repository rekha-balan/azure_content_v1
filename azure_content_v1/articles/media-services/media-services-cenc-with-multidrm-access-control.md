...
* [Introduction](media-services-cenc-with-multidrm-access-control.md#introduction)  * [Overview of this article](media-services-cenc-with-multidrm-access-control.md#overview-of-this-article)
...
* [Implementation](media-services-cenc-with-multidrm-access-control.md#implementation)  * [Implementation procedures](media-services-cenc-with-multidrm-access-control.md#implementation-procedures)
* [Some gotchas in implementation](media-services-cenc-with-multidrm-access-control.md#some-gotchas-in-implementation)


* [Additional Topics for Implementation](media-services-cenc-with-multidrm-access-control.md#additional-topics-for-implementation)  * [HTTP or HTTPS](media-services-cenc-with-multidrm-access-control.md#http-or-https)
...
* [The completed system and test](media-services-cenc-with-multidrm-access-control.md#the-completed-system-and-test)  * [User login](media-services-cenc-with-multidrm-access-control.md#user-login)
...
2. Monthly subscription: Use non-persistent license, and 1-to-1 mapping between content key and asset. In this case:
    ...
    Total # licenses requested for all kids movies/device = [# movies watched]# movies watched] x [# sessions]# sessions]
...
1. Add Permissions to the application in AAD (on Configure tab of the application). This is required for each application (local and deployed versions).

    ![2nd gotcha](./media/media-services-cenc-with-multidrm-access-control/media-services-perms-to-other-apps.png)


1. Use the right issuer in setting up dynamic CENC protection:
...
2. Grant group membership claims privileges. Make sure in AAD application manifest file, we have the following

    "groupMembershipClaims": "All",    (the default value is null)

3. Setting proper TokenType when creating restriction requirements.
...
1. In the Azure AD tenant
   ...
   * add an application (resource) with sign-on URL: 
   ...
   https://[resource_name]resource_name].azurewebsites.net/ and 

   * app ID URL: 

   https://[aad_tenant_name]aad_tenant_name].onmicrosoft.com/[resource_name]resource_name]; 
