...
1. Open a new tab and launch your STS: http://[yourStsName]yourStsName].azurewebsites.net/api/token/assetid/[yourCastLabsAssetId]yourCastLabsAssetId]/contentkeyid/[thecontentkeyid]thecontentkeyid].
