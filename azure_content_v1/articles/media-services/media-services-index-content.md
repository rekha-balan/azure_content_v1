...
For the latest Azure Media Indexer updates, see [Media Services blogs](#preset.md).
...
For more information, see [Task Preset for Azure Media Indexer](#.md).
...
**JobResult.txt** |Output manifest, present only when indexing multiple files, containing the following information:<br/><br/><table border="1"><tr><th>InputFile</th><th>Alias</th><th>MediaLength</th><th>Error</th></tr><tr><td>a.mp4</td><td>Media*1</td><td>300</td><td>0</td></tr><tr><td>b.mp4</td><td>Media*2</td><td>0</td><td>3000</td></tr><tr><td>c.mp4</td><td>Media*3</td><td>600</td><td>0</td></tr></table><br/>



If not all input media files are indexed successfully, the indexing job will fail with error code 4000. For more information, see [Error codes](#error_codes.md).
...
A manifest file with the .lst extension is created and uploading into the asset. The manifest file contains the list of all the asset files. For more information, see [Task Preset for Azure Media Indexer](https://msdn.microsoft.com/library/azure/dn783454.aspx).
    ...
    static bool RunBatchIndexingJob(string[]] inputMediaFiles, string outputFolder)
    {
        ...
        // Declare a new job.
        IJob job = *context.Jobs.Create("My Indexing Job - Batch Mode");
