...
Azure HDInsight deploys and provisions managed Apache Hadoop clusters in the cloud, providing a software framework designed to process, analyze, and report on big data with high reliability and availability. HDInsight uses the **Hortonworks Data Platform (HDP)** Hadoop distribution. Hadoop often refers to the entire Hadoop ecosystem of components, which includes Apache HBase, Apache Spark, and Apache Storm, as well as other technologies under the Hadoop umbrella. See [Overview of the Hadoop ecosystem on HDInsight](#overview.md) below for details.
...
* **Hadoop** (the "Query" workload): Provides reliable data storage with [HDFS](#HDFS.md), and a simple [MapReduce](#mapreduce.md) programming model to process and analyze data in parallel.
...
* **[Ambari](#ambari.md)**: Cluster provisioning, management, monitoring, and utilities.

* **[Avro](#avro.md)** (Microsoft .NET Library for Avro): Data serialization for the Microsoft .NET environment.

* **[Hive & HCatalog](#hive.md)**: Structured Query Language (SQL)-like querying, and a table and storage management layer.

* **[Mahout](#mahout.md)**: Machine learning.

* **[MapReduce](#mapreduce.md)**: Legacy framework for Hadoop distributed processing and resource management. See [YARN](#yarn.md), the next-generation resource framework.

* **[Oozie](#oozie.md)**: Workflow management.

* **[Phoenix](#phoenix.md)**: Relational database layer over HBase.

* **[Pig](#pig.md)**: Simpler scripting for MapReduce transformations.

* **[Sqoop](#sqoop.md)**: Data import and export.

* **[Tez](#tez.md)**: Allows data-intensive processes to run efficiently at scale.

* **[YARN](#yarn.md)**: Part of the Hadoop core library and next generation of the MapReduce software framework.

* **[ZooKeeper](#zookeeper.md)**: Coordination of processes in distributed systems.


> [!NOTE]
> For information on the specific components and version information, see [What's new in the Hadoop cluster versions provided by HDInsight?](hdinsight-component-versioning.md)
> 
> 
...
[YARN](#yarn.md) is the Hadoop next-generation resource manager and application framework, and is referred to as MapReduce 2.0. MapReduce jobs will run on YARN.
...
* State-of-the-art Hadoop components. For details, see [What's new in the Hadoop cluster versions provided by HDInsight?](hdinsight-component-versioning.md).
...
* Integration with other Azure services, including [Web apps](../documentation/services/app-service/web/.md) and [SQL Database](../documentation/services/sql-database/.md).

* Low entry cost. Start a [free trial](/pricing/free-trial/), or consult [HDInsight pricing details](/pricing/details/hdinsight/).


To read more about the advantages on Hadoop in HDInsight, see the  [Azure features page for HDInsight](../services/hdinsight/.md).
