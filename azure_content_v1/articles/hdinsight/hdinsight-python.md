...
> [!NOTE]
> The steps in this article apply to HDInsight cluster versions 2.1, 3.0, 3.1, and 3.2.
> 
> 
...
See [Running the examples](#running.md) for how to run this example on your HDInsight cluster.
...
1. Using the Python examples [streaming.py](#streamingpy.md) and [jython.py](#jythonpy.md), create local copies of the files on your development machine.
