...
> [!NOTE]
> The steps provided here are from a Windows computer.  For the instructions for connecting to a Linux-based HDInsight cluster from Linux, Unix or OS X, see [Use SSH with Linux-based Hadoop on HDInsight from Linux, Unix, or OS X (preview)](hdinsight-hadoop-linux-use-ssh-unix.md)
> 
...
1. In **Category**, click **Session**.
2. From the Basic options for your PuTTY session screen, enter the following values:
...
3. Click **Open** to connect to the cluster.
4. When prompted, enter the user that you entered when you created the cluster. If you provided a password for the user, you will be prompted to enter it also.
5. Run the following command:

        hbase shell
6. Create an HBase with two column families:

        create 'Contacts', 'Personal', 'Office'
     list7. Insert some data:
