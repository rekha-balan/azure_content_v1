...
Script Action can be used when provisioning a cluster using the **Azure Portal**, **Azure PowerShell**, or the **HDInsight .NET SDK**.
...
* [Target the Hadoop version](#bPS1.md)
* [Provide stable links to script resources](#bPS2.md)
* [Use pre-compiled resources](#bPS4.md)
* [Ensure that the cluster customization script is idempotent](#bPS3.md)
* [Ensure high availability of the cluster architecture](#bPS5.md)
* [Configure the custom components to use Azure Blob storage](#bPS6.md)
* [Write information to STDOUT and STDERR](#bPS7.md)
* [Save files as ASCII with LF line endings](#bps8.md)
