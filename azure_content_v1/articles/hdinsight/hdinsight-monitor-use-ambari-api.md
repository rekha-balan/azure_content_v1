...
> 
* **An Azure HDInsight cluster**. For instructions about cluster provisioning, see [Get started using HDInsight](../hdinsight-get-started.md) or [Provision HDInsight clusters](hdinsight-provision-clusters.md). You will need the following data to go through the tutorial:
