...
## Queries
Once the connection is established, you can run queries against Hive. For example, the following Java code performs a **SELECT** from a table, limiting the results to only three rows, then displays the results:
