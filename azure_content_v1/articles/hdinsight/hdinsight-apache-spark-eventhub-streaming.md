...
1. Follow the prompts till the project is completely cloned. Press **Alt + 1** to open the **Project View**. It should resemble the following.
...
6. In the **Output Layout** tab, right at the bottom of the Available Elements box, you have the two dependency jars that you added earlier to the project library. You must add these to the Output Layout tab. Right-click each jar file, and then click **Extract Into Output Root**.
