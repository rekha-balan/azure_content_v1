...
In situations where the error is specific to Azure HDInsight, it might be a good idea to understand what the error is about. Refer to [HDInsight error codes](#hdinsight-error-codes.md) to understand the different error codes, and how to fix those. In some situations, you might want to access the Hadoop logs itself. You can do so directly from the Azure Portal.
...
* [Azure HDInsight SDK documentation](https://msdn.microsoft.com/library/azure/dn469975.aspx)
