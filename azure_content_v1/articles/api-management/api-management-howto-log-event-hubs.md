...
* Authorization : SharedAccessSignature uid=...  * For instructions on generating the `SharedAccessSignature` see [Azure API Management REST API Authentication](https://msdn.microsoft.com/library/azure/dn798668.aspx).
...
## Next steps
* Learn more about Azure Event Hubs  * [Get started with Azure Event Hubs](../event-hubs/event-hubs-csharp-ephcs-getstarted.md)
...
* Learn more about API Management and Event Hubs integration  * [Logger entity reference](https://msdn.microsoft.com/library/azure/mt592020.aspx)
...
> [AZURE.VIDEO integrate-azure-api-management-with-event-hubs]AZURE.VIDEO integrate-azure-api-management-with-event-hubs]
> 
> 
