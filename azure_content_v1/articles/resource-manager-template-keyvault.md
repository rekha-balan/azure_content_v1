...
| properties |object |Yes |([shown below](#properties.md)) |An object that specifies the type of key vault to create. |
...
| accessPolicies |array |Yes |([shown below](#accesspolicies.md)) |An array of up to 16 objects that specify the permissions for the user or service principal. |
| sku |object |Yes |([shown below](#sku.md)) |The SKU for the key vault. |
...
| permissions |object |Yes |([shown below](#permissions.md)) |The permissions granted on this vault to the Active Directory object. |
