...
* If a /29 subnet is used, it will be split into two /30 subnets.   * The first /30 subnet will be used for the primary link and the second /30 subnet will be used for the secondary link.
