...
> [!NOTE]
> ADAL for Android uses an Intent based model to invoke Authentication. Intents lay "over" the app to do work. This entire sample, and indeed all of using ADAL for Android, is managing intents and passing information between them. 
> 
> 
...
> 
 A Developer can skip the broker user with:
    ...
    ```
> [!NOTE]
> In order to reduce the complexity of this B2C Quickstart, we have opted in our sample to skip the broker.
> 
> 
