...
> 
> [!NOTE]
> This sample was written to be connected to with our [iOS B2C sample application.](active-directory-b2c-devquickstarts-ios.md) Please do this walkthrough first, then follow along with that sample.
> 
> 
...
> [!NOTE]
> For our B2C preview you use the same policies across both client and server setups. If you've already went through a walk-through and created these policies there is no need to do so again. Since you've went through this walk-through, you shouldn't need to set up new policeis when you do any client walk-throughs on this site.
> 
> 
