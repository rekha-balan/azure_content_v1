...
> [!NOTE]
> For preview, **Azure Data Catalog** currently supports the following data source and asset types:
> 
> 
* SQL Server Table
* SQL Server View
...
> [!IMPORTANT]
> Deleting a data source from **Azure Data Catalog** only deletes the metadata stored in the **Azure Data Catalog** service. The original data source is not affected in any way.
> 
> 
...
> [!NOTE]
> For the preview of Azure Data Catalog, only Microsoft Excel and SQL Server Reporting Services Report Manager will be directly supported and available in the **Open In** menu.  
> 
> 
