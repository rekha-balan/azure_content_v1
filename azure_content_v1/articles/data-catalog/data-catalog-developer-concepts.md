...
> [!NOTE]
> Properties whose names begin with a double underscore are system types.
> 
> 
<table><tr><td><b>Property Name</b></td><td><b>Data Type</b></td><td><b>Comments</b></td></tr><tr><td>modifiedTime</td><td>DateTime</td><td>The last time the root was modified.  This is set by the client. (The server does not maintain this value).</td></tr><tr><td>**id</td><td>String</td><td>id of the item (read-only). This id is guaranteed to unique to the asset within a catalog.</td></tr><tr><td>**type</td><td>String</td><td>The type of the asset (read-only)</td></tr><tr><td>__creatorId</td><td>String</td><td>A string used by the creator of the asset to uniquely identify the asset. </td></tr></table>
