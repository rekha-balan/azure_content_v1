...
| Partition Key Column [optional]optional] |This column contains the partition key for Event Hub output. |
...
> [!NOTE]
> At this time, creation and configuration of Power BI outputs is not supported in the Azure Preview Portal.
> 
> 
