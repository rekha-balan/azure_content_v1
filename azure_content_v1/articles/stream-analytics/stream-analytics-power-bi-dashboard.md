...
> [!NOTE]
> Power BI output is a preview feature of Azure Stream Analytics. At this time, creation and configuration of Power BI outputs is not supported in the Azure Preview Portal.
> 
> 
## Prerequisites
...
* Type or select the following values on the third page:  * **Input Alias** - Enter a friendly name for this job input. Note that you will be using this name in the query later on.
...
* Specify the following values:  * **Event Serializer Format** - JSON
* **Encoding** - UTF8
