...
1. [Create a new application gateway](#create-a-new-application-gateway.md)
2. [Upload SSL certificates](#upload-ssl-certificates.md)
3. [Configure the gateway](#configure-the-gateway.md)
4. [Set the gateway configuration](#set-the-gateway-configuration.md)
5. [Start the gateway](#start-the-gateway.md)
6. [Verify the gateway status](#verify-the-gateway-status.md)
