...
2. [Configure the gateway](#configure-the-gateway.md)
3. [Set the gateway configuration](#set-the-gateway-configuration.md)
4. [Start the gateway](#start-the-gateway.md)
5. [Verify the gateway](#verify-the-gateway-status.md)
