...
* [Point-to-site connectivity](../vpn-gateway-point-to-site-create.md)  
  ...
  > [!NOTE]
> Every app service environment has a virtual  network associated with it. You can establish this network connectivity to this virtual network.  
* [Hybrid connections](../web-sites-hybrid-connection-get-started.md)  

  > [!NOTE]
> Every registered API in your app service environment has a corresponding web app. You can establish hybrid connections from this web app just like you can from any other web app.
> 
> 
