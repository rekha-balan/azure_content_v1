...
8. Set the **Reply URL** under the *OAuth 2* section to the redirect URL you received when you added the new Office 365 Outlook API in the Azure Portal (in this topic). Then, select **Add application**:  
...
10. Back in the configure page, note that *Office 365 Exchange Online* is added to the *Permission to other applications* list.

11. Select **Delegated Permissions** for *Office 365 Exchange Online*, and select the following permissions:  
