...
5. Save the URL you used; you'll use it again later in the tutorial.
...
11. To verify that this request would not work without the authentication token, delete the authentication header and click Send again.
