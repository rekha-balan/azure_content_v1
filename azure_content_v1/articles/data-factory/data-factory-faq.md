...
* For comprehensive documentation, see [Azure Data Factory documentation](http://go.microsoft.com/fwlink/?LinkId=516909).

### How do customers access Data Factory?
Customers can get access to Data Factory through the [Azure Portal](http://portal.azure.com).
...
* **REST API**. You can also use the REST API exposed by the Azure Data Factory service to create and deploy data factories. See [Data Factory REST API Reference](https://msdn.microsoft.com/library/dn906738.aspx) for  a comprehensive documentation of Data Factory REST API. 
