...
8. Use the cmdlet **New-AzureRmDataFactoryLinkedService** to create a Linked Service as follows. 
...
3. In the **Azure Portal**, click **Pipelines** tile (not on the names of the pipelines) in the **DATA FACTORY** blade for the **LogProcessingFactory**, you should see the pipelines you created.

   ![All Pipelines][image-data-factory-tutorial-pipelines-all]

4. In the **DATA FACTORY** blade for the **LogProcessingFactory**, click **Diagram**.
...
Practice the [Walkthrough: Using on-premises data source](data-factory-tutorial-extend-onpremises-using-powershell.md) to learn how to create a pipeline to copy marketing campaign effectiveness data to an on-premises SQL Server database.
