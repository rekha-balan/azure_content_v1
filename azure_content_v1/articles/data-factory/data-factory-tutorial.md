...
1. After logging into the [Azure Portal](http://portal.azure.com), click **NEW** from the bottom-left corner, click **Data analytics** in the **Create** blade, and click **Data Factory** on the **Data analytics** blade. 

   ![New->DataFactory][image-data-factory-new-datafactory-menu] 

2. In the **New data factory** blade, enter **LogProcessingFactory** for the **Name**.

    ![Data Factory Blade][image-data-factory-tutorial-new-datafactory-blade]

3. If you haven’t created an Azure resource group named **ADF** already, do the following:
...
4. Select **ADF** for the **RESOURCE GROUP NAME**.  
5. In the **New data factory** blade, notice that **Add to Startboard** is selected by default. This add a link to data factory on the startboard (what you see when you login to Azure Portal).

   ![Create Data Factory Blade][image-data-factory-tutorial-create-datafactory]

6. In the **New data factory** blade, click **Create** to create the data factory.

7. After the data factory is created, you should see the **DATA FACTORY** blade titled **LogProcessingFactory**.
...
> [!NOTE]
> This article uses the Azure Classic Portal, specifically the Data Factory Editor, to create linked services, tables, and pipelines. See [Tutorial using Azure PowerShell](data-factory-tutorial-using-powershell.md) if you want to perform this tutorial using Azure PowerShell. 
> 
> 
...
4. Click **Deploy** on the toolbar to create and deploy the AzureSqlLinkedService.
