...
For more information on how the model was created from the original data set, see the [Cortana Analytics Gallery Predictive Maintenance Template](http://gallery.cortanaanalytics.com/Collection/Predictive-Maintenance-Template-3).
