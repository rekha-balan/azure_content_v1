...
1. Download the the web installer for the .NET framework you want to install   * [.NET 4.5.2 Web Installer](http://go.microsoft.com/fwlink/p/?LinkId=397703)
...
2. For a Web Role   1. In **Solution Explorer**, under In **Roles** in the cloud service project right click on your role and select **Add>New Folder**. Create a folder named *bin*
2. Right click on the **bin** folder and select **Add>Existing Item**. Select the .NET installer and add it to the bin folder.


3. For a Worker Role   1. Right click on your role and select **Add>Existing Item**. Select the .NET installer and add it to the role. 
