...
Note that before you can delete a service, all deployments for the the service must first be deleted. (See [How to: Delete a deployment](#DeleteDeployment.md) for details.)
...
To create a virtual machine, you first need to create a [cloud service](#CreateCloudService.md).  Then create the virtual machine deployment using the **create\_virtual\_machine\_deployment** method:
