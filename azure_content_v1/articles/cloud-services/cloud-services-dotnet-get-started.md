...
The `<Instances>` setting specifies the number of virtual machines that Azure will run the worker role code on. The [Next steps](#next-steps.md) section includes links to more information about scaling out a cloud service,
...
4. In the **ContosAdsWeb [Role]Role]** properties window, click the **Settings** tab, and then click **Add Setting**.
...
8. Still in the **ContosoAdsWorker [Role]Role]** properties window, add another connection string:
