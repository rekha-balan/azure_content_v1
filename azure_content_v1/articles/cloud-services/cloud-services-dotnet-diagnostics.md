...
For a more detailed comparison, see [Comparing Azure Diagnostics Versions](#comparing.md) at the end of this article.
...
1. Save the file and select **Build Solution** from the **Build** menu to build your code.
...
The Diagnostics configuration file defines values that are used to initialize diagnostic configuration settings when the diagnostics monitor starts. A sample configuration file and detailed documentation on its schema is located here: [Azure Diagnostics 1.2 Configuration Schema](http://msdn.microsoft.com/library/azure/dn782207.aspx).
