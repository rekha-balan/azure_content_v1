...
* [Allowed service changes during an update](#AllowedChanges.md)
* [Rollback of an update](#RollbackofanUpdate.md)
* [Initiating multiple mutating operations on an ongoing deployment](#multiplemutatingoperations.md)
* [Distribution of roles across upgrade domains](#distributiondfroles.md)
* [How an upgrade proceeds](#howanupgradeproceeds.md)
