...
* Create an Azure storage account
  ...
  > [!NOTE]
> Also make a note of your Azure subscription ID, which you will need later. Find this in your Azure [account information](https://account.windowsazure.com/Subscriptions)</a>.
> 
> 
...
10. In the Create Node Template Wizard, do the following:
    ...
    > [!NOTE]
> By default, the Azure node template includes settings for you to start (provision) and stop the nodes manually. You can optionally configure a schedule to start and stop the Azure nodes automatically.
> 
> 
...
## Related resources
* [HPC Pack 2012 R2 and HPC Pack 2012]HPC Pack 2012 R2 and HPC Pack 2012](http://go.microsoft.com/fwlink/p/?LinkID=263697
