...
For more information on additional design considerations of a multitenant application, see [Hosting a Multi-Tenant Application on Azure](http://msdn.microsoft.com/library/hh534480.aspx).
...
* Web Services in Worker Roles  * Worker Roles. that typically process data on the backend of an application.
