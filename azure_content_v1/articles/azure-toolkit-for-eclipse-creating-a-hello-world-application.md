...
2. In the Eclipse toolbar, click the **Publish to Azure Cloud** button,
 ![][ic710882]
...
4. In the **Publish to Azure** dialog:   1. If there are no subscriptions to select in the **Subscription** list yet, follow these steps to import your subscription information:   1. Click **Import from PUBLISH-SETTINGS file**.
