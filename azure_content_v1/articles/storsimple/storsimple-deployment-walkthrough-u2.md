...
| [Deployment prerequisites](#deployment-prerequisites.md) |These  validate the environment is ready for deployment. |
|  | |
...
| [Step 2: Get the service registration key](#step-2-get-the-service-registration-key.md) |Use this key to register & connect your StorSimple device with the management service. |
...
| [Step 4: Complete minimum device setup](#step-4-complete-minimum-device-setupd.md)</br>[Optional: Update your StorSimple device](#scan-for-and-apply-updates.md) |Use the management service to complete the device setup and enable it to provide storage. |
