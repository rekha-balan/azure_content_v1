...
* [Scope pane](#scope-pane.md) 
* [Results pane](#results-pane.md) 
* [Actions pane](#actions-pane.md) 

Additionally, the StorSimple Snapshot Manager supports [keyboard navigation and a number of shortcuts](#keyboard-navigation-and-shortcuts.md).
...
* For a description of the StorSimple Snapshot Manager accessibility features, go to [Keyboard navigation and shortcuts](#keyboard-navigation-and-shortcuts.md).


## Menu bar
The menu bar at the top of the console window contains [File](#file-menu.md), [Action](#action-menu.md), [View](#view-menu.md), [Favorites](#favorites-menu.md), [Window](#window-menu.md), and [Help](#help-menu.md) menus.
...
* [Devices node](#devices-node.md) 
* [Volumes node](#volumes-node.md) 
* [Volume Groups node](#volume-groups-node.md) 
* [Backup Policies node](#backup-policies-node.md) 
* [Backup Catalog node](#backup-catalog-node.md) 
* [Jobs node](#jobs-node.md) 
...
* [Keyboard navigation keys](#keyboard-navigation-keys.md) 
* [Menu bar shortcut keys](#menu-bar-shortcut-keys.md) 
* [Scope pane shortcut keys](#scope-pane-shortcut-keys.md) 
...
The following table describes the shortcut key combinations for the menu bar. After you press the shortcut keys and the menu opens, you can use menu shortcut keys (the underlined keys on the menu). For more information about the menu bar, go to [Menu bar](#menu-bar.md).
...
* [Devices node shortcut keys](#devices-node-shortcut-keys.md)
* [Volumes node shortcut keys](#volumes-node-shortcut-keys.md)
* [Volume Groups node shortcut keys](#volume-groups-node-shortcut-keys.md)
* [Backup Policies node shortcut keys](#backup-policies-node-shortcut-keys.md)
* [Backup Catalog node shortcut keys](#backup-catalog-node-shortcut-keys.md)
* [Jobs node shortcut keys](#jobs-node-shortcut-keys.md)
