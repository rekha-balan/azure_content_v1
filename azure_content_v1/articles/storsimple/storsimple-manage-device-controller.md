...
1. Use the [restart or shut down a controller](#restart-or-shut-down-a-single-controller.md) procedure to identify and shut down the passive controller on your device. You can perform this operation in the Azure classic portal or in Windows PowerShell for StorSimple.
