...
5. Under **Additional Settings**, you can do the following:
   ...
   * Modify the ACRs, provided that the volume is offline. If the volume is online, you will need to take it offline first. Refer to the steps in [Take a volume offline](#take-a-volume-offline.md) prior to modifying the ACR.
