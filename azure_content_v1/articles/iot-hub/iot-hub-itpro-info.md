...
* The [security section in the Azure IoT Hub developer guide](iot-hub-devguide.md#security) provides additional information about the tokens and permission system in IoT Hub.
* [Manage IoT Hub through the Azure portal](iot-hub-manage-through-portal.md) describes how to use the Azure portal to manage your IoT hub.
