...
6. After the load test is created, open the .loadtest project and choose the current run setting, such as **Run Settings** > **Run Settings1 [Active]Active]**. This opens the run settings in the **Properties** window.
