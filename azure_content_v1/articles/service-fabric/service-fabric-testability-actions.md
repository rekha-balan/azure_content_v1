...
* [Run an action against a one-box cluster](#run-an-action-against-a-one-box-cluster.md)
* [Run an action against an Azure cluster](#run-an-action-against-an-azure-cluster.md)
...
For further information, see [PartitionSelector and ReplicaSelector](#partition_replica_selector.md).
...
* How to test your service  * [Simulate failures during service workloads](service-fabric-testability-workload-tests.md)
