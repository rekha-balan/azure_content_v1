...
> [!NOTE]
> If you are using push notifications elsewhere in your application then you have to [share your push channel](#push-channel-sharing.md) with Engagement Reach.
> 
> 
## Integration
...
> [!TIP]
> You should consider adding a root level `<Grid></Grid>` element to surround all page content. For Webview integration, just add Webview as child of this grid. If you need to set Engagement component elsewhere, remember that you have to manage the display size yourself.
> 
> 
### Overlay integration
