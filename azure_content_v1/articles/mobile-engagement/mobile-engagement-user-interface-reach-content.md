...
* **Android + iOS actions**  * Open a web page
...
* **Android only actions**  * Download an application on the Play Store
...
* **iOS only actions**  * Download an application on the App Store
* http://itunes.apple.com/[country]country]/app/[app name]app name]/id[app id]app id]?mt=8 
