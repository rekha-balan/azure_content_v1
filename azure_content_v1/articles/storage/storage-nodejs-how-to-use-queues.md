...
Create a blank Node.js application. For instructions creating a Node.js application, see [Create and deploy a Node.js application to an Azure Web Site](../web-sites-nodejs-develop-deploy-mac.md), [Node.js Cloud Service](../cloud-services-nodejs-develop-deploy-app.md) (using Windows PowerShell), or [Web Site with WebMatrix](../web-sites-nodejs-use-webmatrix.md).
...
For an example of setting the environment variables in the [Azure Portal](https://portal.azure.com) for an Azure Website, see [Node.js Web Application with Storage](../storage-nodejs-use-table-storage-web-site.md)
