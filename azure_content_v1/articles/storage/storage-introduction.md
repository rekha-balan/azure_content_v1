...
For details on tools, libraries, and other resources for working with Azure Storage, see [Next Steps](next-steps.md) below.
...
* [Azure PowerShell](http://go.microsoft.com/?linkid=9811175clcid=0x409)
