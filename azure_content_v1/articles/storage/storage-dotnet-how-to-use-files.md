...
> [AZURE.VIDEO azure-file-storage-with-windows]AZURE.VIDEO azure-file-storage-with-windows]
> 
> 
## About this tutorial
...
* Use the Azure Storage Client Library for .NET to access the file share from an on-premises application. Create a console application and perform these actions with the file share:  * Write the contents of a file in the share to the console window.
...
To work with File storage programmatically, you can use the storage client libraries for .NET and Java, or the Azure Storage REST API. The example in this section demonstrates how to work with a file share by using the [Azure .NET Storage Client Library](http://go.microsoft.com/fwlink/?LinkID=390731clcid=0x409) from a simple console application running on the desktop.
...
### Blog posts
* [Azure File storage is now generally available](http://go.microsoft.com/fwlink/?LinkID=626728clcid=0x409)
* [Deep dive with Azure File storage](http://go.microsoft.com/fwlink/?LinkID=626729clcid=0x409) 
