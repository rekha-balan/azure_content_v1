...
* [Introduction](#introduction.md)  * [How this guide is organized](#how-this-guide-is-organized.md)


* [Monitoring your storage service](#monitoring-your-storage-service.md)  * [Monitoring service health](#monitoring-service-health.md)
* [Monitoring capacity](#monitoring-capacity.md)
* [Monitoring availability](#monitoring-availability.md)
* [Monitoring performance](#monitoring-performance.md)


* [Diagnosing storage issues](#diagnosing-storage-issues.md)  * [Service health issues](#service-health-issues.md)
* [Performance issues](#performance-issues.md)
* [Diagnosing errors](#diagnosing-errors.md)
* [Storage emulator issues](#storage-emulator-issues.md)
* [Storage logging tools](#storage-logging-tools.md)
* [Using network logging tools](#using-network-logging-tools.md)


* [End-to-end tracing](#end-to-end-tracing.md)  * [Correlating log data](#correlating-log-data.md)
* [Client request ID](#client-request-id.md)
* [Server request ID](#server-request-id.md)
* [Timestamps](#timestamps.md)


* [Troubleshooting guidance](#troubleshooting-guidance.md)  * [Metrics show high AverageE2ELatency and low AverageServerLatency](#metrics-show-high-AverageE2ELatency-and-low-AverageServerLatency.md)
* [Metrics show low AverageE2ELatency and low AverageServerLatency but the client is experiencing high latency](#metrics-show-low-AverageE2ELatency-and-low-AverageServerLatency.md)
* [Metrics show high AverageServerLatency](#metrics-show-high-AverageServerLatency.md)
* [You are experiencing unexpected delays in message delivery on a queue](#you-are-experiencing-unexpected-delays-in-message-delivery.md)
* [Metrics show an increase in PercentThrottlingError](#metrics-show-an-increase-in-PercentThrottlingError.md)
* [Metrics show an increase in PercentTimeoutError](#metrics-show-an-increase-in-PercentTimeoutError.md)
* [Metrics show an increase in PercentNetworkError](#metrics-show-an-increase-in-PercentNetworkError.md)
* [The client is receiving HTTP 403 (Forbidden) messages](#the-client-is-receiving-403-messages.md)
* [The client is receiving HTTP 404 (Not found) messages](#the-client-is-receiving-404-messages.md)
* [The client is receiving HTTP 409 (Conflict) messages](#the-client-is-receiving-409-messages.md)
* [Metrics show low PercentSuccess or analytics log entries have operations with transaction status of ClientOtherErrors](#metrics-show-low-percent-success.md)
* [Capacity metrics show an unexpected increase in storage capacity usage](#capacity-metrics-show-an-unexpected-increase.md)
* [You are experiencing unexpected reboots of Virtual Machines that have a large number of attached VHDs](#you-are-experiencing-unexpected-reboots.md)
* [Your issue arises from using the storage emulator for development or test](#your-issue-arises-from-using-the-storage-emulator.md)
* [You are encountering problems installing the Azure SDK for .NET](#you-are-encountering-problems-installing-the-Windows-Azure-SDK.md)
* [You have a different issue with a storage service](#you-have-a-different-issue-with-a-storage-service.md)


* [Appendices](#appendices.md)  * [Appendix 1: Using Fiddler to capture HTTP and HTTPS traffic](#appendix-1.md)
* [Appendix 2: Using Wireshark to capture network traffic](#appendix-2.md)
* [Appendix 3: Using Microsoft Message Analyzer to capture network traffic](#appendix-3.md)
* [Appendix 4: Using Excel to view metrics and log data](#appendix-4.md)
* [Appendix 5: Monitoring with Application Insights for Visual Studio Team Services](#appendix-5.md)
...
The section "[Monitoring your storage service](#monitoring-your-storage-service.md)" describes how to monitor the health and performance of your Azure Storage services using Azure Storage Analytics Metrics (Storage Metrics).

The section "[Diagnosing storage issues](#diagnosing-storage-issues.md)" describes how to diagnose issues using Azure Storage Analytics Logging (Storage Logging). It also describes how to enable client-side logging using the facilities in one of the client libraries such as the Storage Client Library for .NET or the Azure SDK for Java.

The section "[End-to-end tracing](#end-to-end-tracing.md)" describes how you can correlate the information contained in various log files and metrics data.

The section "[Troubleshooting guidance](#troubleshooting-guidance.md)" provides troubleshooting guidance for some of the common storage-related issues you might encounter.

The "[Appendices](#appendices.md)" include information about using other tools such as Wireshark and Netmon for analyzing network packet data, Fiddler for analyzing HTTP/HTTPS messages, and Microsoft Message Analyzer for correlating log data.
...
* Investigating potential issues using diagnostics tools as discussed later in the section "[Diagnosing storage issues](#diagnosing-storage-issues.md)."
...
The "[Troubleshooting guidance](#troubleshooting-guidance.md)" section of this guide describes some common storage service issues related to availability.
...
The "[Troubleshooting guidance](#troubleshooting-guidance.md)" section of this guide describes some common storage service issues related to performance.
...
* Significant changes from baseline values in the metrics you are monitoring as described in the previous section "[Monitoring your storage service](#monitoring-your-storage-service.md)."
...
The following sections outline the steps you should follow to diagnose and troubleshoot issues in each of these four categories. The section "[Troubleshooting guidance](#troubleshooting-guidance.md)" later in this guide provides more detail for some common issues you may encounter.
...
The section "[Troubleshooting guidance](#troubleshooting-guidance.md)" later in this guide provides more information about some common performance related issues you may encounter.
...
The "[Troubleshooting guidance](#troubleshooting-guidance.md)" section of this guide describes some common issues encountered using the storage emulator.
...
* [Metrics show high AverageE2ELatency and low AverageServerLatency](#metrics-show-high-AverageE2ELatency-and-low-AverageServerLatency.md)
* [Metrics show low AverageE2ELatency and low AverageServerLatency but the client is experiencing high latency](#metrics-show-low-AverageE2ELatency-and-low-AverageServerLatency.md)
* [Metrics show high AverageServerLatency](#metrics-show-high-AverageServerLatency.md)
* [You are experiencing unexpected delays in message delivery on a queue](#you-are-experiencing-unexpected-delays-in-message-delivery.md)
...
For more information about using Wireshark to troubleshoot network issues, see "[Appendix 2: Using Wireshark to capture network traffic](#appendix-2.md)."

For more information about using Microsoft Message Analyzer to troubleshoot network issues, see "[Appendix 3: Using Microsoft Message Analyzer to capture network traffic](#appendix-3.md)."
...
In the case of high **AverageServerLatency** for blob download requests, you should use the Storage Logging logs to see if there are repeated requests for the same blob (or set of blobs). For blob upload requests, you should investigate what block size the client is using (for example, blocks less than 64K in size can result in overheads unless the reads are also in less than 64K chunks), and if multiple clients are uploading blocks to the same blob in parallel. You should also check the per-minute metrics for spikes in the number of requests that result in exceeding the per second scalability targets: also see "[Metrics show an increase in PercentTimeoutError](#metrics-show-an-increase-in-PercentTimeoutError.md)."
...
High **AverageServerLatency** values can also be a symptom of poorly designed tables or queries that result in scan operations or that follow the append/prepend anti-pattern. See "[Metrics show an increase in PercentThrottlingError](#metrics-show-an-increase-in-PercentThrottlingError.md)" for more information.

> [!NOTE]
> You can find a comprehensive checklist including other issues to be aware here: "[Designing Scalable and Performant Storage Based Applications Checklist](storage-performance-checklist.md)."
> 
> 
...
* [Transient increase in PercentThrottlingError](#transient-increase-in-PercentThrottlingError.md)
* [Permanent increase in PercentThrottlingError error](#permanent-increase-in-PercentThrottlingError.md)
...
* [The client or another process previously deleted the object](#client-previously-deleted-the-object.md)
* [A Shared Access Signature (SAS) authorization issue](#SAS-authorization-issue.md)
* [Client-side JavaScript code does not have permission to access the object](#JavaScript-code-does-not-have-permission.md)
* [Network failure](#network-failure.md)
...
If an Azure Virtual Machine (VM) has a large number of attached VHDs that are in the same storage account, you could exceed the scalability targets for an individual storage account causing the VM to fail. You should check the minute metrics for the storage account (**TotalRequests**/**TotalIngress**/**TotalEgress**) for spikes that exceed the scalability targets for a storage account. See the section "[Metrics show an increase in PercentThrottlingError](#metrics-show-an-increase-in-PercentThrottlingError.md)" for assistance in determining if throttling has occurred on your storage account.
...
* [Feature "X" is not working in the storage emulator](#feature-X-is-not-working.md)
* [Error "The value for one of the HTTP headers is not in the correct format" when using the storage emulator](#error-HTTP-header-not-correct-format.md)
* [Running the storage emulator requires administrative privileges](#storage-emulator-requires-administrative-privileges.md)
...
For more information about using Fiddler, see "[Appendix 1: Using Fiddler to capture HTTP and HTTPS traffic](#appendix-1.md)."

For more information about using Wireshark, see "[Appendix 2: Using Wireshark to capture network traffic](#appendix-2.md)."

For more information about using Microsoft Message Analyzer, see "[Appendix 3: Using Microsoft Message Analyzer to capture network traffic](#appendix-3.md)."
