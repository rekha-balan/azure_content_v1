...
For instructions on how to create a Node.js application, see [Create and deploy a Node.js application to an Azure website]Create and deploy a Node.js application to an Azure website], [Node.js Cloud Service](../cloud-services-nodejs-develop-deploy-app.md) (using Windows PowerShell), or [Web app with WebMatrix](../web-sites-nodejs-use-webmatrix.md).
...
For an example of setting the environment variables in the [Azure Portal](https://portal.azure.com) for an Azure web app, see [Node.js Web Application with Storage](../storage-nodejs-use-table-storage-web-site.md)
...
> [!NOTE]
> Page blobs consist of 512-byte 'pages'. You may receive an error when uploading data with a size that is not a multiple of 512.
> 
> 
