...
> [!NOTE]
> This guide assumes that you have installed AzCopy 5.0 or later.
> 
> 
...
> [!NOTE]
> Beginning with AzCopy version 3.0.0, the AzCopy command-line syntax requires that every parameter be specified to include the parameter name, *e.g.*, `/ParameterName:ParameterValue`.
> 
> 
...
<table>
  ...
  <tr>
    ...
    <td>Indicates whether to transfer snapshots. This option is only valid when the source is a blob. 
        <br /><br />
        The transferred blob snapshots are renamed in this format: [blob-name](snapshot-time.md)[extension]extension]. 
        <br /><br />
  ...
  <tr>
    <td><b>/V:[verbose log-file]verbose log-file]</b></td>
  ...
  <tr>
    <td><b>/Z:[journal-file-folder]journal-file-folder]</b></td>
  ...
  <tr>
    <td><b>/IA:[RASHCNETOI]RASHCNETOI]</b></td>
  ...
  <tr>
    <td><b>/XA:[RASHCNETOI]RASHCNETOI]</b></td>
...
For more information about working with your storage access keys, please see [View, copy, and regenerate storage access keys](../storage-create-storage-account/#regeneratestoragekeys.md).
...
## AzCopy versions
> [!NOTE]
> We recommand you install the latest version of AzCopy to get new features and better performance.
> 
> 
