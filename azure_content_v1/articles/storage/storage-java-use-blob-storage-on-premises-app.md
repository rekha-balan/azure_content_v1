...
* An Azure storage account has been set up. The account name
  ...
  and [How to Manage Storage Accounts](storage-create-storage-account.md#view-copy-and-regenerate-storage-access-keys) for information about retrieving the
  account key.
...
use the blob storage service from Java](storage-java-how-to-use-blob-storage.md).
