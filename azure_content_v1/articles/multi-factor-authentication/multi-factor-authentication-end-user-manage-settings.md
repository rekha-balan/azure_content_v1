...
* [Correlation ID Errors](#correlation-id-errors.md)
* [I have lost my phone or it was stolen](#i-have-lost-my-phone-or-it-was-stolen?.md)
* [I want to change my phone number](#i-want-to-change-my-phone-number.md)
* [I have a new phone and need to change my phone number](#i-have-a-new-phone-and-need-to-change-my-phone-number.md)
* [I am not receiving a code on my phone](#i-am-not-receiving-a-code-on-my-phone.md)
* [App passwords are not working](#app-passwords-are-not-working.md)
* [How do I clean up Azure Authenticator from my old device and move to a new one?](#how-do-i-clean-up-azure-authenticator-from-my-old-device-and-move-to-a-new-one.md)
* [I didn't find an answer to my problem](#i-didn't-find-an-answer-to-my-problem.md)

## Correlation ID Errors
If you've tried the troubleshooting steps below and are still running into problems, you can post a question on the [Azure AD Forums](https://social.msdn.microsoft.com/forums/azure/home?forum=WindowsAzureAD), [Search the Microsoft Knowledge Base (KB)](https://www.microsoft.com/en-us/Search/result.aspx?q=azure%20active%20directory%20connectform=mssupport) or [contact support](https://support.microsoft.com/en-us) and we'll take a look at your problem as soon as we can.
...
|:--- |:--- |
| [I use it with Office 365](#changing-your-settings-with-office-365.md) |This means that you will want to change your settings through the Office 365 portal. |
| [I don't know](#changing-your-settings-with-the-myapps-portal.md) |This means you will want to sign-in to [http://myapps.microsoft.com](http://myapps.microsoft.com) and change your setting here. |
| [I use it with Microsoft Azure](#changing-your-settings-with-microsoft-azure.md) |This means that you will want to change your settings through the Azure portal. |
...
If didn't find an answer to your problem on this page, you can post a question on the [Azure AD Forums](https://social.msdn.microsoft.com/forums/azure/home?forum=WindowsAzureAD), [Search the Microsoft Knowledge Base (KB)](https://www.microsoft.com/en-us/Search/result.aspx?q=azure%20active%20directory%20connectform=mssupport) or [contact support](https://support.microsoft.com/en-us).
