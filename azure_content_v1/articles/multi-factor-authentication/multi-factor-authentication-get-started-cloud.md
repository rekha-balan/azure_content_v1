...
5. Fill in the following fields and select Create.   1. Name – The name of the Multi-Factor Auth Provider.
...
1. Once you click create, the Multi-Factor Authentication Provider will be created and you should see a message stating: Successfully created Multi-Factor Authentication Provider. Click Ok.
