...
|:--- |:--- |
| [I use it with Office 365](#creating-and-deleting-app-passwords-with-office-365.md) |This means that you will want to create app passwords through the Office 365 portal. |
| [I don't know](#creating-and-deleting-app-passwords-with-myapps-portal.md) |This means you will want create app passwords through [https://myapps.microsoft.com](https://myapps.microsoft.com) |
| [I use it with Microsoft Azure](#create-app-passwords-in-the-azure-portal.md) |This means that you will want create app passwords through the Azure portal. |
