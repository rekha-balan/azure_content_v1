...
> [!IMPORTANT]
> Are you here because you want to reset your Azure or O365 password?  If so, please [skip to this section](#users-how-to-manage-your-own-password.md).
> 
> 
...
| Topic |  |
| --- | --- |
| Supported scenarios |[What is possible with Azure AD Password Reset?](#what-is-possible-with-azure-ad-password-reset.md) |
| Why use it? |[Why use Azure AD Password Reset?](#why-use-azure-ad-password-reset.md) |
| Pricing and availability |[Pricing and availability](#pricing-and-availability.md) |
| Enable password reset |[Enable password reset for your users](#enable-password-reset-for-your-users.md) |
| Customize how it works |[Customize password reset behavior](#customize-password-reset-behavior.md) |
| Roll it out to my users |[Configure your users to use password reset](#configure-your-users-to-use-password-reset.md) |
| View reports |[View password reset activity with integrated reports](#view-password-reset-activity-with-integrated-reports.md) |
| Reset a user's password |[Manage your users' passwords](#manage-your-users-passwords.md) |
| Set my organization's password policies |[Set password policies](#set-password-policies.md) |
| Troubleshoot a problem |[Troubleshoot a problem](#troubleshoot-a-problem.md) |
| FAQ |[Read a FAQ](#read-a-faq.md) |
| Technical details |[Understand the technical details](#understand-the-technical-details.md) |
| Newly released features |[Recent service updates](#recent-service-updates.md) |
| Links to other documentation |[Links to password reset documentation](#links-to-password-reset-documentation.md) |
