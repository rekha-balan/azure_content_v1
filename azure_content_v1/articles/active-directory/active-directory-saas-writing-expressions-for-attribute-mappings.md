...
* You can pass three different types of arguments into functions:
  ...
  1. Attributes, which must be enclosed in square square brackets. For example: [attributeName]attributeName]
...
## List of Functions
[Append](#append.md) &nbsp;&nbsp;&nbsp;&nbsp; [FormatDateTime](#formatdatetime.md) &nbsp;&nbsp;&nbsp;&nbsp; [Join](#join.md) &nbsp;&nbsp;&nbsp;&nbsp; [Mid](#mid.md) &nbsp;&nbsp;&nbsp;&nbsp; [Not](#not.md) &nbsp;&nbsp;&nbsp;&nbsp; [Replace](#replace.md) &nbsp;&nbsp;&nbsp;&nbsp; [StripSpaces](#stripspaces.md) &nbsp;&nbsp;&nbsp;&nbsp; [Switch](#switch.md)
