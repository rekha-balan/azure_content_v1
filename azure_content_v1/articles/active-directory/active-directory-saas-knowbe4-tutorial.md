...
3. **[Creating a KnowBe4 test user](#creating-a-KnowBe4-test-user.md)** - to have a counterpart of Britta Simon in KnowBe4 that is linked to the Azure AD representation of her.
...
1. To get SSO configured for your application, contact your [KnowBe4 support team](mailto:support@knowbe4.com). Attach the downloaded certificate file to your mail and share the metadata urls (Entity ID, SSO Sign in URL and Sign Out URL) with KnowBe4 team to set up SSO on their side.
