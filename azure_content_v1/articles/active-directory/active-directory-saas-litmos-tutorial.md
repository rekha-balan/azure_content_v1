...
3. **[Creating a Litmos test user](#creating-a-halogen-software-test-user.md)** - to have a counterpart of Britta Simon in Litmos that is linked to the Azure AD representation of her.
...
2. Copy the value under **The SAML endoiint for litmos is:**.
<br><br> ![Azure AD Single Sign-On][26] <br>


1. In the Azure classic portal, on the **Configure App Settings** dialog page, perform the following steps:
...
2. On the **Configure single sign-on at Litmos** page, perform the following steps:
