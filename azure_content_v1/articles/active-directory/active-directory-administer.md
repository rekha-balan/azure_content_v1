...
* [Microsoft Intune](https://account.manage.microsoft.com/Signup/MainSignUp.aspx?OfferId=40BE278A-DFD1-470a-9EF7-9F2596EA7FF9ali=1)
...
* **Synchronization independence**. You can configure each Azure AD independently to get data synchronized from a single instance of either:  * The directory sync tool, to synchronize data with a single AD forest
