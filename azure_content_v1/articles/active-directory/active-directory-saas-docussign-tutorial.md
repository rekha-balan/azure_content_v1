...
1. [Configuring single sign-on](#configuring-single-sign-on.md) 

1. [Configuring account provisioning](#configuring-account-provisioning.md) 

1. [Assigning users](#assigning-users.md) 
...
2. In the results pane, select **Docusign**, and then click **Complete** to add the application.
...
1. In a different web browser window, log into your **Docusign** company site as an administrator.

1. In the menu on the top, expand the user’s menu, click **Preferences**, and then, in the navigation pane on the left, expand **Account Management**, and then click **Features**.
<br><br>![Configuring single sign-on ][11]<br>

2. Click **SAML Configuration**, and then click the **SAML Configuration** link.


1. In the **SAML 2.0 Configuration** section, perform the following steps:
...
1. On the Azure AD portal, select the **single sign-on configuration confirmation**, and then click **Next**.
...
1. On the **Settings and admin credentials** page, to enable automatic user provisioning, provide the credentials of a DocuSign account with sufficient rights, and then click **Next**. 
<br><br>![Configuring account provisioning][31]<br>

2. On the **Test connection** dialog, click **Start test**, and upon a successful test, click **Next**.
...
1. Select your test user, click **Assign**, and then click **Yes** to confirm your assignment.
