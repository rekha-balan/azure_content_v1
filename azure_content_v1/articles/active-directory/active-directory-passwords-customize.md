...
| Topic |  |
| --- | --- |
| How do I enable or disable password reset? |[Setting: users enabled for password reset](#users-enabled-for-password-reset.md) |
| How do I scope password reset to a specific set of users? |[Restrict password reset to specific users](#restrict-access-to-password-reset.md) |
| How do I change what authentication methods are supported? |[Setting: authentication methods available to users](#authentication-methods-available-to-users.md) |
| How do I change number of authentication methods required? |[Setting: number of authentication methods required](#number-of-authentication-methods-required.md) |
| How do I set up custom security questions? |[Setting: custom security questions](#custom-security-questions.md) |
| How do I set up pre-canned localized security questions? |[Setting: knowledge-based security questions](#knowledge-based-security-questions.md) |
| How can I change how many security questions are required? |[Setting: number of security questions for registration or reset](#number-of-questions-required-to-register.md) |
| How can I force my users to register when signing in? |[Enforced registration-based rollout of password reset](#require-users-to-register-when-signing-in.md) |
| How can I force my users to re-confirm their registered periodically? |[Setting: number of days before users must re-confirm their authentication data](#number-of-days-before-users-must-confirm-their-contact-data.md) |
| How can I customize how a user gets in touch with an admin? |[Setting: customize the "contact your administrator" link](#customize-the-contact-your-administrator-link.md) |
| How can I allow users to unlock AD accounts without resetting a password? |[Setting: enable users to unlock their AD accounts without resetting a password](#allow-users-to-unlock-accounts-without-resetting-their-password.md) |
| How can I enable password reset notifications for users? |[Setting: notify users when their passwords have been reset](#notify-users-and-admins-when-their-own-password-has-been-reset.md) |
| How can I enable password reset notifications for admins? |[Setting: notify other admins when an admin reset their own password](#notify-admins-when-other-admins-reset-their-own-passwords.md) |
| How can I customize password reset look and feel? |[Setting: company name, branding, and logo ](#password-managment-look-and-feel.md) |
