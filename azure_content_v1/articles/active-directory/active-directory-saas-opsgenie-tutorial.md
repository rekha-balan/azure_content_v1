...
3. **[Creating a OpsGenie test user](#creating-a-opsgenie-test-user.md)** - to have a counterpart of Britta Simon in OpsGenie that is linked to the Azure AD representation of her.
