...
3. **[Creating a Amazon Web Service (AWS) test user](#creating-a-halogen-software-test-user.md)** - to have a counterpart of Britta Simon in Amazon Web Service (AWS) that is linked to the Azure AD representation of her.
...
3. On the **Set Role Name** dialog, perform the following steps: 
...
4. On the **Select Role Type** dialog, perform the following steps: 
...
1. On the **Establish Trust** dialog, perform the following steps:  
...
1. On the **Verify Role Trust** dialog, click **Next Step**. 
<br><br>![Configure Single Sign-On][32]<br>

1. On the **Attach Policy** dialog, click **Next Step**.  
...
2. On the Azure AD portal, select the single sign-on configuration confirmation, and then click **Next**.
<br><br>![What is Azure AD Connect][20]<br>

3. On the **Single sign-on confirmation** page, click **Complete** to close the **Configure single sign-on** dialog.
...
3. On the Add User Attribute dialog, perform the following steps. 
<br><br>![Configure Single Sign-On][24]<br> 

    a. In the **Attribute Name** textbox, type **https://aws.amazon.com/SAML/Attributes/Role**.

    b. In the **Attribute Value** textbox, type **[the Role ARN value]the Role ARN value],[the Trusted Entity ARN value]the Trusted Entity ARN value]**.
