...
3. **[Creating a Flatter Files test user](#creating-a-halogen-software-test-user.md)** - to have a counterpart of Britta Simon in Flatter Files that is linked to the Azure AD representation of her.
...
1. On the **Configure single sign-on at Flatter Files** page, perform the following steps:
...
2. In the Azure AD classic portal, select the single sign-on configuration confirmation, and then click **Next**. 
