...
3. **[Creating a 23 Video test user](#creating-a-23-video-test-user.md)** - to have a counterpart of Britta Simon in 23 Video that is linked to the Azure AD representation of her.
...
1. In **Users** section, click **Configure**.
<br><br>![Assign User][400]<br>

2. Click **Add a new user**. 
<br><br>![Assign User][401]<br>

3. In the **Invite someone to join this site** section, perform the following steps:
