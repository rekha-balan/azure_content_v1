...
> 
> 
* [Add and verify a domain using the Azure classic portal](#add-and-verify-a-domain-using-the-azure-management-portal.md)
* [Edit DNS records for your cloud services](#edit-dns-records-for-your-cloud-services.md)
* [Verify a domain at any domain name registrar](#verify-a-domain-at-any-domain-name-registrar.md)

### Add and verify a domain using the Azure classic portal
1. In the Azure classic portal, click **Active Directory**, and then click on the name of your organization's directory.You can do one of the following:   1. On the default directory page, click **Add Domain** in the **Improve user sign-in experience **section.
2. Click **Domains** and then click either **Add a customer domain** or the **Add** button.


2. On the **Add domain** page, type the domain name that you want to add and the do one of the following:   1. If you do not plan to integrate your on-premises Active Directory with Azure AD, do the following:   1. Leave the **I plan to configure this domain for single sign-on with my local Active Directory** checkbox cleared, and then click the **Add** button.
...
2. If you want to integrate your on-premises Active Directory with Azure AD, do the following:   1. Make sure to select the **I plan to configure this domain for single sign-on with my local Active Directory** checkbox and then click the **Add** button.
...
> [!NOTE]
> After you add your domain name to Azure AD, you can change the default domain name for new email addresses. For more information, see [How can I change the primary domain name for users?](#how-can-i-change-the-primary-domain-name-for-users?.md) You can also edit the profile for an existing user account to update the email address (which is also your user ID) to use your custom domain name instead of the onmicrosoft.com domain.
> 
> 
...
3. On the **Verify** page, in the **Record Type** drop-down list, choose either **TXT record** or **MX record**.
4. Copy or record the information under it.
...
3. Follow the instructions provided to complete the verification process.   * If domain verification succeeds, you will be notified that your domain has been added to your account.
