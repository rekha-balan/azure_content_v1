...
3. **[Creating a QuickHelp test user](#creating-a-quickhelp-test-user.md)** - to have a counterpart of Britta Simon in QuickHelp that is linked to the Azure AD representation of her.
...
1. On the **Configure single sign-on at QuickHelp** page, perform the following steps:click **Download metadata**, and then save the metadata file locally on your computer.
...
3. On the **Authentication Settings** page, perform the following steps
