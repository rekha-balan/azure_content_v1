...
3. **[Creating a Moxtra test user](#creating-a-moxtra-test-user.md)** - to have a counterpart of Britta Simon in Moxtra that is linked to the Azure AD representation of her.
...
1. On the **Configure single sign-on at Moxtra** page, perform the following steps:
...
2. In the toolbar on the left, click **Admin Console > SAML Single Sign-on**, and then **New**.
