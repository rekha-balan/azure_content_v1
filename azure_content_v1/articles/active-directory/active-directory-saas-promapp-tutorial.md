...
3. **[Creating a Promapp test user](#creating-a-halogen-software-test-user.md)** - to have a counterpart of Britta Simon in Promapp that is linked to the Azure AD representation of her.
