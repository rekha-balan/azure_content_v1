...
3. **[Creating a Skilljar test user](#creating-a-skilljar-test-user.md)** - to have a counterpart of Britta Simon in Skilljar that is linked to the Azure AD representation of her.
...
1. To get SSO configured for your application, contact your Skilljar support team via email, include the **Name Identifier Format** value from the previous step and attach the downloaded metadata file.
