...
3. **[Creating a Tidemark test user](#creating-a-Tidemark-test-user.md)** - to have a counterpart of Britta Simon in Tidemark that is linked to the Azure AD representation of her.
...
1. To get SSO configured for your application, contact your Tidemark support team and attach the downloaded certificate file to your email. Also please do provide the SAML SSO URL, Sign Out URL and Issuer URL so that they can be configured for SSO integration.
