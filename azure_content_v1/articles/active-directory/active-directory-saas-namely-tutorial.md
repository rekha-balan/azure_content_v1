...
3. **[Creating a Namely test user](#creating-a-namely-test-user.md)** - to have a counterpart of Britta Simon in Namely that is linked to the Azure AD representation of her.
...
1. On the **Configure single sign-on at Namely** page, perform the following steps:
