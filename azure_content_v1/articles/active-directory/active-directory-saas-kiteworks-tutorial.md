...
3. **[Creating a Kiteworks test user](#creating-a-kiteworks-test-user.md)** - to have a counterpart of Britta Simon in Kiteworks that is linked to the Azure AD representation of her.
