...
3. **[Creating a @Tasktest user](#creating-a-halogen-software-test-user.md)** - to have a counterpart of Britta Simon in @Taskthat is linked to the Azure AD representation of her.
