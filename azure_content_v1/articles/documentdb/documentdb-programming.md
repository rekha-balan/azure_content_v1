...
> [AZURE.VIDEO azure-demo-a-quick-intro-to-azure-documentdbs-server-side-javascript]AZURE.VIDEO azure-demo-a-quick-intro-to-azure-documentdbs-server-side-javascript]
> 
> 
...
<ul>
<li>
<b>chain() ... .value([callback] [, options]callback] [, options], options])</b>
<ul>
<li>
...
<li>
<b>filter(predicateFunction [, options] [, callback], options] [, callback], callback])</b>
<ul>
<li>
...
<li>
<b>map(transformationFunction [, options] [, callback], options] [, callback], callback])</b>
<ul>
<li>
...
<li>
<b>pluck([propertyName] [, options]propertyName] [, options] [, callback], options] [, callback], callback])</b>
<ul>
<li>
...
<li>
<b>flatten([isShallow] [, options]isShallow] [, options] [, callback], options] [, callback], callback])</b>
<ul>
<li>
...
<li>
<b>sortBy([predicate] [, options]predicate] [, options] [, callback], options] [, callback], callback])</b>
<ul>
<li>
...
<li>
<b>sortByDescending([predicate] [, options]predicate] [, options] [, callback], options] [, callback], callback])</b>
<ul>
<li>
...
* [Service Oriented Database Architecture](http://dl.acm.org/citation.cfm?id=1066267coll=Portaldl=GUIDE) 
