...
1. Sign into the [Azure Classic Portal](https://manage.windowsazure.com/).
   ...
   > [!NOTE]
> Azure HDInsight is currently supported in the Azure Classic Portal, while Azure DocumentDB only exists in the Microsoft Azure  portal.
> 
...
3. Enter the **URL**, select the **LOCATION** and **REPLICATION** values, and then click **CREATE STORAGE ACCOUNT**. Affinity groups are not supported. 
   ...
   > [!IMPORTANT]
> For best performance, make sure your storage account, HDInsight cluster, and DocumentDB account are located in the same Azure region. Azure regions that support all three services are:  **East Asia**, **Southeast Asia**, **North Europe**, **West Europe**, **East US**, and **West US**.
> 
