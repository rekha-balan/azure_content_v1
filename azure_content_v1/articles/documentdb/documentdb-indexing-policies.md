...
<table border="0" cellspacing="0" cellpadding="0">
    <tbody>
        ...
        <tr>
            ...
            <td valign="top">
                <p>
                    Index path required to serve iteration and JOIN queries against arrays of scalars like ["a", "b", "c"]"a", "b", "c"]:
                </p>
                <p>
        ...
        <tr>
            ...
            <td valign="top">
                <p>
                    Index path required to serve iteration and JOIN queries against arrays of objects like [{subprop: "a"}, {subprop: "b"}]{subprop: "a"}, {subprop: "b"}]:
                </p>
                <p>
            ...
            <td valign="top">
                <p>
                    Range over /prop/? (or /*) can be used to serve the following queries efficiently:
                        ...
                        WHERE ST_DISTANCE(c.prop, {"type": "Point", "coordinates": [0.0, 10.0]0.0, 10.0]}) < 40
