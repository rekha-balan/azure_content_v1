...
* **dataChangeDetectionPolicy**: Optional. See [Data Change Detection Policy](#DataChangeDetectionPolicy.md) below.

* **dataDeletionDetectionPolicy**: Optional. See [Data Deletion Detection Policy](#DataDeletionDetectionPolicy.md) below.
...
> [!NOTE]
> You will need to include the property in your SELECT clause if you are using a custom projection.
> 
> 
...
| GeoJSON objects e.g. { "type": "Point", "coordinates": [ long, lat ] long, lat ] } |Edm.GeographyPoint |
...
* **schedule**: Optional. See [Indexing Schedule](#IndexingSchedule.md) below.
