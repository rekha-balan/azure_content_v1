...
You should already have the [Xamarin.Android](http://xamarin.com/download/) and the [Azure Mobile Services Component](http://components.xamarin.com/view/azure-mobile-services/) installed in your project from when you completed either [Get started with Mobile Services](mobile-services-ios-get-started.md).
