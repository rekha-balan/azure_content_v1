...
1. [Register your app for push notifications](#register.md)
2. [Update the service to send push notifications](#update-service.md)
3. [Test push notifications in your app](#test.md)
