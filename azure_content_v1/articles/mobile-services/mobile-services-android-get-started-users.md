...
> [AZURE.VIDEO android-getting-started-with-authentication-in-windows-azure-mobile-services]AZURE.VIDEO android-getting-started-with-authentication-in-windows-azure-mobile-services]
> 
> 
...
[Store authentication tokens on the client]Store authentication tokens on the client]: #cache-tokens
[Refresh expired tokens]Refresh expired tokens]: #refresh-tokens
