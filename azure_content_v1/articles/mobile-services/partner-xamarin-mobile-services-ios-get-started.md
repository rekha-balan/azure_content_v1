...
Completing this tutorial requires XCode and [Xamarin Studio](http://xamarin.com/download) for OS X or the Xamarin Visual Studio plug-in for Visual Studio on Windows. The sample will run on iOS 5.0 and newer.
