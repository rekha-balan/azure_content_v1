...
* For a PhoneGap or Cordova app, add the [Mobile Services plugin](https://github.com/Azure/azure-mobile-services-cordova) to your project. This plugin supports [push notifications](#push-notifications.md).
...
Once you have registered your identity provider, simply call the [LoginAsync method]LoginAsync method] with the [MobileServiceAuthenticationProvider]MobileServiceAuthenticationProvider] value of your provider. For example, to login with Facebook use the following code.
