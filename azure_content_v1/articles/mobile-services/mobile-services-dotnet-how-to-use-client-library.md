...
This is the typed serialization model; see the discussion of the [untyped serialization model](#untyped.md) below.
...
<!-- Anchors. -->
[What is Mobile Services]What is Mobile Services]: #what-is
[Concepts]Concepts]: #concepts
[How to: Create the Mobile Services client]How to: Create the Mobile Services client]: #create-client
[How to: Create a table reference]How to: Create a table reference]: #instantiating
[How to: Query data from a mobile service]How to: Query data from a mobile service]: #querying
...
[How to: Bind data to user interface in a mobile service]How to: Bind data to user interface in a mobile service]: #binding
[How to: Insert data into a mobile service]How to: Insert data into a mobile service]: #inserting
[How to: Modify data in a mobile service]How to: Modify data in a mobile service]: #modifying
[How to: Delete data in a mobile service]How to: Delete data in a mobile service]: #deleting
[How to: Use Optimistic Concurrency]How to: Use Optimistic Concurrency]: #optimisticconcurrency
[How to: Authenticate users]How to: Authenticate users]: #authentication
[How to: Handle errors]How to: Handle errors]: #errors
[How to: Design unit tests]How to: Design unit tests]: #unit-testing
[How to: Query data from a mobile service]How to: Query data from a mobile service]: #querying
[How to: Customize the client]How to: Customize the client]: #customizing
[How to: Work with untyped data]How to: Work with untyped data]: #untyped
[Customize request headers]Customize request headers]: #headers
[Customize serialization]Customize serialization]: #serialization
[Next steps]Next steps]: #nextsteps
[Caching the authentication token]Caching the authentication token]: #caching
[How to: Call a custom API]How to: Call a custom API]: #custom-api
