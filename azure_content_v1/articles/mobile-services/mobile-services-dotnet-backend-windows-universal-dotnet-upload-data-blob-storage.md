...
[Install the storage client in the mobile service project]Install the storage client in the mobile service project]: #storage-client-server
[Update the TodoItem definition in the data model]Update the TodoItem definition in the data model]: #update-data-model
[Update the table controller to generate an SAS]Update the table controller to generate an SAS]: #update-scripts
