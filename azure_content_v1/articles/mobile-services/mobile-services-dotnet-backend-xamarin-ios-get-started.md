...
> [!TIP]
> If you are new to mobile development using Microsoft Azure, [get started with Azure Mobile Apps](app-service-mobile-dotnet-backend-xamarin-ios-get-started-preview.md) instead of Azure Mobile Services; Mobile Apps gives you [additional advantages](app-service-mobile-value-prop-migration-from-mobile-services-preview.md).
> 
> 
...
4. Download and install [Xcode](https://go.microsoft.com/fwLink/?LinkID=266532clcid=0x409) v4.4 or a later version and [Xamarin Studio](http://xamarin.com/download). You can also use Xamarin for Visual Studio.
