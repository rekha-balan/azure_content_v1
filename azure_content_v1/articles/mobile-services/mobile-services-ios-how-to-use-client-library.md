...
> [!NOTE]
> This guide uses the latest [iOS Mobile Services SDK](https://go.microsoft.com/fwLink/?LinkID=266533clcid=0x409). If your project uses an older version of the SDK, first upgrade the framework in Xcode.
> 
> 
...
Let's see how you may cache tokens in the [Mobile Services Quick Start](mobile-services-ios-get-started.md) project; you may apply similar steps to any project. 
