...
> [!NOTE]
> This is an Azure Mobile Services topic. Microsoft Azure recommends Azure App Service Mobile Apps for all new mobile backend deployments. For more information, see the [equivalent tutorial in Mobile Apps documentation](../app-service-mobile/app-service-mobile-xamarin-ios-get-started-users.md).
> 
> 
...
In the next tutorial, [Service-side authorization of Mobile Services users](../mobile-services-dotnet-backend-windows-store-dotnet-authorize-users-in-scripts.md), you will take the user ID value provided by Mobile Services based on an authenticated user and use it to filter the data returned by Mobile Services.
