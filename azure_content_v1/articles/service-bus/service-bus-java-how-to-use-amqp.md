...
* qpid-amqp-1-0-client-[version]version].jar
* qpid-amqp-1-0-client-jms-[version]version].jar
* qpid-amqp-1-0-common-[version]version].jar
...
Where **[jndi_name]jndi_name]** and **[ConnectionURL]ConnectionURL]** have the following meanings:

* **[jndi_name]jndi_name]**: The logical name of the ConnectionFactory. This is the name that will be resolved in the Java application using the JNDI IntialContext.lookup() method.
* **[ConnectionURL]ConnectionURL]**: A URL that provides the JMS library with the information required to the AMQP broker.
...
Where **[namespace]namespace]**, **[username]username]** and **[password]password]** have the following meanings:

* **[namespace]namespace]**: The Service Bus namespace.
* **[username]username]**: The Service Bus issuer name.
* **[password]password]**: URL-encoded form of the Service Bus issuer key.
...
Where **[jndi\_name]jndi\_name]** and **[physical\_name]physical\_name]** have the following meanings:

* **[jndi_name]jndi_name]**: The logical name of the destination. This is the name that will be resolved in the Java application using the JNDI IntialContext.lookup() method.
* **[physical_name]physical_name]**: The name of the Service Bus entity to which the application sends or receives messages.
