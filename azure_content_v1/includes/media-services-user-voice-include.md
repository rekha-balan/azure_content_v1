Use the [User Voice](http://go.microsoft.com/fwlink/?linkid=698785clcid=0x409) forum to provide feedback and make suggestions on how to improve Azure Media Services. You can also go directly to one of the following categories: 
