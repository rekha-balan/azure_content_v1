...
* Follow the steps in the tutorial [Create a mobile app](../article/app-service-mobile/app-service-mobile-xamarin-ios-get-started.md) to create both a mobile app backend and a client. You can use any client platform supported by Mobile Apps, including iOS, Windows, Xamarin iOS, and Xamarin Android.
...
> [!NOTE]
> Before completing these steps, ensure that you've initialized your mobile app backend database by connecting a client to it. Otherwise, the web app will not be able to connect to the same database.
> 
> 
...
2. Download the sample solution [MultiChannelToDo](https://github.com/Azure/mobile-services-samples/tree/web-mobile/MultiChannelToDo) and open in Visual Studio. The solution contains both a Web API project and a Web Application Project for the web client UI.
...
2. Run the mobile app that you created in the [Create a mobile app](../article/app-service-mobile/app-service-mobile-xamarin-ios-get-started.md) tutorial. You will see the same todo items as in the web app.
