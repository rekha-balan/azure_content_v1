...
1. [Prepare to run the Maintainer executable](#to-prepare-to-run-the-maintainer.md) .

2. [Prepare the content database and Recycle Bin for immediate deletion of orphaned BLOBs](#to-prepare-the-content-database-and-recycle-bin-to-immediately-delete-orphaned-blobs.md).

3. [Run Maintainer.exe](#to-run-the-maintainer.md).

4. [Revert the content database and Recycle Bin settings](#to-revert-the-content-database-and-recycle-bin-settings.md).
