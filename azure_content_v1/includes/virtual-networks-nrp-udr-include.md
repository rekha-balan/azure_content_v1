...
| --- | --- | --- |
| **routes** |Collection of user defined routes in the route table |see [user defined routes](#User-defined-routes.md) |
| **subnets** |Collection of subnets the route table is applied to |see [subnets](#Subnets.md) |
