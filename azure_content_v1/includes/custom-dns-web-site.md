...
* [Understanding CNAME and A records](#understanding-records.md)
* [Configure your web sites for shared or standard mode](#bkmk_configsharedmode.md)
* [Add your web sites to Traffic Manager](#trafficmanager.md)
* [Add a CNAME for your custom domain](#bkmk_configurecname.md)
* [Add an A record for your custom domain](#bkmk_configurearecord.md)
...
1. In the **general** section, set the website mode by clicking **SHARED**.
...
3. When prompted about the increase in cost for Shared mode (or for Standard mode if you choose Standard), click **Yes** if you agree.
