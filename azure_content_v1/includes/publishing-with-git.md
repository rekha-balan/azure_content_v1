...
The steps for pushing your Visual Studio solution to Web Apps is the same as in the [previous section](#Step7.md), provided that you configure your solution and repository as follows:
