...
## Table of Contents
* [Running Windows Server Active Directory in virtual machines](#adinvm.md)

* [Using Azure Active Directory](#ad.md)

* [Using Azure Active Directory Access Control](#ac.md)


## <a name="adinvm"></a>Running Windows Server Active Directory in virtual machines
Running Windows Server AD in Azure virtual machines is much like running it on-premises. [Figure 1](#fig1.md) shows a typical example of how this looks.
...
[Figure 2](#fig2.md) illustrates the first of these two options, where Azure Active Directory is all that's required.
...
But why do this? Why not instead create an intermediary that can generate a single token format with a common representation of identity information? This approach would make life simpler for the developers who create applications, since they now need to handle only one kind of token. Azure Active Directory Access Control does exactly this, providing an intermediary in the cloud for working with diverse tokens. [Figure 4](#fig4.md) shows how it works
