...
10. Create a new class called **LoggerBolt** with the following code:
    ...
    This Storm bolt logs the content of the received events. This can easily be extended to store tuples in a storage service. The [HDInsight sensor analysis tutorial]HDInsight sensor analysis tutorial] uses this same approach to store data into HBase.
...
[HDInsight Storm]HDInsight Storm]: ../hdinsight/hdinsight-storm-overview.md
[HDInsight sensor analysis tutorial]HDInsight sensor analysis tutorial]: ../hdinsight/hdinsight-storm-sensor-data-analysis.md
