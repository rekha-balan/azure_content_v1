...
CDN node locations, see [Azure CDN Node Locations](http://msdn.microsoft.com/library/windowsazure/gg680302.aspx).

This task includes the following steps:

* [Step 1: Create a storage account](#Step1.md)
* [Step 2: Create a new CDN endpoint for your storage account](#Step2.md)
* [Step 3: Access your CDN content](#Step3.md)
* [Step 4: Remove your CDN content](#Step4.md)
...
Existing CDN customers can now use the Azure CDN in the [Azure classic portal](https://manage.windowsazure.com/). The CDN is an add-on feature to your subscription and has a separate [billing plan](/pricing/calculator/?scenario=full).
...
1. In the [Azure classic portal](https://manage.windowsazure.com/), in the navigation pane, click **CDN**.
